...
If you want personalised numbers, jump straight to the [Net Salary Calculator](/tools/salary-checker/) or the [30% Ruling Calculator](/tools/30-percent-ruling-calculator/).
...
| City | Avg Gross Salary | Avg Net (est.) | Cost-Adjusted Value |
|------|-----------------|----------------|---------------------|
| Amsterdam | €52,000 | €35,100 | Low (very high rent) |
| Den Haag | €50,000 | €34,000 | Medium |
| Utrecht | €49,000 | €33,500 | Medium |
| Eindhoven | €51,000 | €34,600 | High (low rent, ASML effect) |
| Rotterdam | €47,000 | €32,200 | Medium |
| Groningen | €42,000 | €29,400 | High (low rent, student city) |
...
**Rotterdam** has been closing the gap with Amsterdam in recent years, particularly in logistics, port industry, and architecture. Rents remain 20–30% below Amsterdam. See the [Rotterdam city guide](/cities/rotterdam/) for sector-specific details.

**Den Haag** is the seat of government and home to many international organisations, NGOs, and embassies. Government and legal sector salaries are solid; private sector tends to be slightly below Amsterdam. See the [Den Haag city guide](/cities/the-hague/).

For detailed cost comparisons, the [Cost of Living Netherlands 2026](/guides/housing/cost-of-living-netherlands-2026/) guide has full monthly budget breakdowns by city.
...
| Sector | Junior (0–3 yr) | Mid (3–7 yr) | Senior (7+ yr) |
|--------|----------------|-------------|----------------|
...
| | Amsterdam | Eindhoven | Rotterdam | Den Haag |
|--|-----------|-----------|-----------|---------|
| Software Eng | Very High | Very High | High | Medium |
| Data Science | Very High | Very High | High | Medium |
| Finance | Very High | Medium | High | Medium |
| Consulting | Very High | Medium | High | High |
| Engineering (non-IT) | High | Very High | Very High | Medium |
| Marketing | High | Medium | Medium | Medium |
...
**[Net Salary Calculator Netherlands 2026](/tools/salary-checker/)** — Enter your gross salary and see your estimated monthly net take-home, with and without the 30% ruling.

**[30% Ruling Calculator Netherlands 2026](/tools/30-percent-ruling-calculator/)** — See exactly how much the 30% ruling saves you across all three phases (30%, 20%, 10%) over the 5-year period.

**[Cost of Living Calculator](/tools/cost-of-living-calculator/)** — Compare your salary against actual living costs in your target city.
...
| Phase | Months | Tax-Free % | Taxable % |
|-------|--------|-----------|-----------|
| Phase 1 | 1–20 | 30% | 70% |
| Phase 2 | 21–40 | 20% | 80% |
| Phase 3 | 41–60 | 10% | 90% |

For full eligibility rules, how to apply, and what happens when you change employers, see the [30% Ruling Netherlands 2026 guide](/guides/finance/30-percent-ruling-netherlands-2026/).
...
| Age | Hourly Minimum Wage | Monthly Est. (40hr week) | % of Adult Rate |
|-----|--------------------|-----------------------|-----------------|
| 21 and over | €14.06 | €2,437 | 100% |
| 20 | €11.25 | €1,949 | 80% |
| 19 | €9.84 | €1,705 | 70% |
| 18 | €8.44 | €1,462 | 60% |
...
The [Dutch Employment Contract Guide](/guides/work/dutch-employment-contract-explained-2026/) explains how minimum wages interact with fixed-term contracts, part-time work, and zero-hours agreements.
...
| Gross Annual Salary | Vakantiegeld (8%) | Gross Monthly Without | Gross May (With Vakantiegeld) |
|--------------------|--------------------|----------------------|------------------------------|
...
**If you leave mid-year:** When an employment contract ends, any accrued but unpaid vakantiegeld must be paid out in your final salary. Keep records so you can check this on your [loonstrook (pay slip)](/guides/work/dutch-pay-slip-loonstrook-explained-2026/).

**Freelancers (ZZP) do not receive vakantiegeld** by default. If you freelance in the Netherlands, you need to build the equivalent into your day rate. The [ZZP and Freelancer Guide](/guides/work/freelancer-zzp-guide-netherlands-2026/) covers this in detail.
...
For tactics, scripts, and what to say when they counter-offer, see the full [Salary Negotiation Guide Netherlands 2026](/guides/work/salary-negotiation-netherlands-expats-2026/).
...
The [Dutch Pay Slip Guide (Loonstrook Explained)](/guides/work/dutch-pay-slip-loonstrook-explained-2026/) walks through every line item with a real example.
...
| [Dutch Tax System Guide](/guides/finance/dutch-tax-system-expats-guide-2026/) | Box 1/2/3, brackets, deductions |
| [Employment Contract Guide](/guides/work/dutch-employment-contract-explained-2026/) | Contract types, rights, notice periods |
| [Pay Slip Guide (Loonstrook)](/guides/work/dutch-pay-slip-loonstrook-explained-2026/) | Decoding every line on your loonstrook |
| [Amsterdam City Guide](/cities/amsterdam/) | Amsterdam job market, neighbourhoods, cost breakdown |
| [Eindhoven City Guide](/cities/eindhoven/) | Tech salary hotspot, ASML, cost of living |
| [Rotterdam City Guide](/cities/rotterdam/) | Port economy, sectors, rent |
| [Utrecht City Guide](/cities/utrecht/) | Mid-size city, growing tech sector |
...
> Sarah van den Berg, "Netherlands Salary Comparison by City and Sector 2026," Expat Netherlands Hub, 17 March 2026. [https://expatnetherlandshub.com/salary-comparison/](https://expatnetherlandshub.com/salary-comparison/)
