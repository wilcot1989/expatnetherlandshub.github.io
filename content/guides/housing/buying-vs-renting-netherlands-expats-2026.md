...
A decent two-bedroom apartment in the private rental sector in Utrecht, Eindhoven, or The Hague currently costs around **€1,500 per month** for an unfurnished unit. That is the number I keep hearing from clients in 2026. In Amsterdam, add another €300 to €500. In Groningen or Tilburg, subtract €200.
...
| Stay duration | Buy or rent? | Why |
|---|---|---|
| Under 2 years | Rent | Transaction costs far exceed any gains |
| 2-3 years | Probably rent | Too close to call, uncertainty too high |
| 3-5 years | Borderline | Depends heavily on price appreciation |
| 5+ years | Lean toward buying | Equity accumulation and rent stability win |
| 8+ years | Strong case for buying | Compounding equity and fixed payments |

The "3 to 5 years" rule of thumb you often hear is accurate as a rough guide. But I want to be honest: in a flat or declining market, even a five-year ownership window can leave you worse off than renting, once you factor in maintenance, opportunity cost on the transaction costs, and selling fees.

For a deeper breakdown of the mortgage mechanics, see my guide to [Dutch mortgages explained for expats](/guides/finance/dutch-mortgage-explained-expats-2026/).

## The 30% Ruling and What It Does to Your Mortgage Capacity

This is the bit that trips up almost every expat buyer I work with.

If you benefit from the [30% ruling](/guides/finance/30-percent-ruling-netherlands-2026/), a significant portion of your salary is paid as a tax-free allowance. On paper, your total compensation package is strong. In practice, your taxable income — the number banks use for mortgage assessment — is lower than what hits your bank account.
...
My recommendation: size your mortgage based on your taxable salary alone. Use the 30% ruling income only for your down payment savings or to build a financial buffer.

For the full picture on mortgage options, see [expat mortgage options in the Netherlands](/guides/housing/expat-mortgage-options-netherlands-2026/) and the [complete guide to buying a house in the Netherlands as an expat](/guides/finance/buying-house-netherlands-expat-guide-2026/).
...
In 2026, the maximum deduction rate is approximately **36.97%** (aligned with the lowest tax bracket rate). This means for every €1,000 of mortgage interest you pay, you get back roughly €370 from the tax authority.
...
**Reason 1: Your plans genuinely might change.** I have seen this hundreds of times. Expats arrive planning to stay forever. A parent gets ill back home. A better job appears in Singapore. A relationship ends. The Netherlands is not the right place anymore. If you have bought a property and need to sell quickly, you are almost certainly selling at a loss after transaction costs — and potentially in a difficult market.
...
- **Starters** benefit from the 0% overdrachtsbelasting exemption, but the €510,000 limit rules out many Amsterdam properties
...
Here is the framework I use with clients to cut through the noise.
...
Use [rental contract rights for expats](/guides/legal/dutch-rental-contract-rights-expats-2026/) to understand what you are giving up if you leave renting. Use the [housing budget checker](/tools/housing-budget-checker/) to see what you can actually borrow.
...
<a href="https://go.expatnetherlandshub.com/wise?ref=/guides/housing/buying-vs-renting-netherlands-expats-2026/" target="_blank" rel="nofollow noopener sponsored" class="cta-affiliate">Transfer your down payment with Wise →</a>
...
**The mortgage application timeline.** From first contact with a hypotheekadviseur to receiving the final mortgage offer typically takes 4-8 weeks. Add another 2-6 weeks for the actual property transfer at the notaris. Do not make an offer without first checking your maximum mortgage via a [mortgage capacity check](/tools/housing-budget-checker/) or speaking to an independent advisor.

**NHG (Nationale Hypotheek Garantie).** If you are buying a property priced under €435,000 in 2026, you may be eligible for NHG — a government guarantee that lowers your mortgage interest rate (typically by 0.3 to 0.5%) and provides a safety net if you cannot pay. The fee is 0.6% of the mortgage (approximately €2,100 on a €350,000 loan), but the rate saving more than compensates for this over time. Most expat buyers should at least explore NHG eligibility.
...
|---|---|---|
| Upfront cost | Security deposit (1-2 months) | ~€14,250 + any down payment |
...
| Flexibility to leave | 1-3 months' notice | 3-6 months minimum |
| Maintenance responsibility | Landlord | You |
| Risk if property value falls | None | Real financial risk |
| Visa/residence dependency | Lower risk | Higher risk |
| Tax benefit | None | Hypotheekrenteaftrek |
| Break-even vs renting | N/A | 3.5-5 years |

## My Honest Take

I bought in 2019 and I do not regret it. My mortgage payment has not moved. The apartment two floors down in my building is now renting for €200 more per month than I pay in total housing costs. The equity I have built gives me options I would not otherwise have.

But I was also lucky on the timing, certain about staying, and had a permanent contract with a Dutch employer. If any of those three things had been different, I might have made a different call.
...
Use the [cost of living calculator](/tools/cost-of-living-calculator/) to model your own numbers and make the right call for your situation.

---

*Sarah van den Berg is an expat coach and relocation specialist based in Utrecht. She has helped over 400 expats make housing decisions in the Netherlands. This article reflects market conditions as of May 2026 and is not financial advice.*
