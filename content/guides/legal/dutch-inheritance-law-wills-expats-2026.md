...
I have sat with clients who lost a spouse without a will in place and discovered that what they thought they owned jointly was, under Dutch law, automatically shared with their adult children from a previous marriage. I have also seen situations where a Dutch will made no provision for assets in a home country, creating significant legal costs to resolve.
...
| Group | Who |
|---|---|
| First | Partner and/or children |
| Second | Parents, brothers and sisters (and their descendants) |
| Third | Grandparents |
| Fourth | Great-grandparents |
| If no relatives found | Estate goes to the Dutch state (Staat der Nederlanden) |
...
| Beneficiary | Rate on amounts above exemption |
|---|---|
| Partner / children | 10% up to €138,641; 20% above |
| Grandchildren | 18% up to €138,641; 36% above |
| Others | 30% up to €138,641; 40% above |
...
- [Centraal Testamentenregister](https://www.testamentenregister.nl)
- [Belastingdienst: Erfbelasting](https://www.belastingdienst.nl/wps/wcm/connect/bldcontentnl/belastingdienst/prive/relaties_familie_en_gezondheid/erven_en_schenken/)
- [EU Succession Regulation full text](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32012R0650)
- [Rechtbank: Inheritance proceedings](https://www.rechtspraak.nl)
