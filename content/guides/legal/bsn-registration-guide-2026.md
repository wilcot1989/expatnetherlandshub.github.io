---
title: "BSN Number in the Netherlands: How to Register Step by Step in 2026"
date: 2026-03-10T10:00:00+01:00
description: "Complete guide to getting your BSN number in the Netherlands. Registration at the gemeente, required documents, appointment booking, and what to do while waiting."
categories: ["legal"]
...
If you are still in the planning phase, read my [moving to the Netherlands](/guides/legal/complete-guide-moving-to-netherlands-2026/) guide first — the BSN fits into a wider sequence of administrative steps that are easier to understand in order.
...
| Action | Timing |
|--------|--------|
| Book gemeente appointment | As soon as you have a confirmed Dutch address |
| Gather and apostille documents | 4–8 weeks before move (if coming from outside EU) |
| Arrive in the Netherlands | Day 0 |
| Attend gemeente appointment | As booked — aim for within first 2 weeks |
| Receive BSN | Same day as appointment |
| Apply for DigiD | Day of BSN receipt or shortly after |
| Open Dutch bank account | Within first week of having BSN |
| Register health insurance | Within 4 months of arrival (or 4 months of losing coverage elsewhere) |

If you are coming as a highly skilled migrant through your employer, your HR or relocation contact may assist with parts of this process. Check my [HSM visa guide](/guides/legal/highly-skilled-migrant-visa-netherlands-2026/) for how the IND residence permit process connects with gemeente registration.
...
**Tips:** The Hague has a well-organised expat infrastructure given the high concentration of international organisations and embassies. The Expat Centre The Hague, based at the City Hall on Spui, is well-resourced and the staff are used to dealing with complex registration situations. Wait times here tend to be shorter than Amsterdam.
...
If you are relocating to the tech hub, my [moving to Eindhoven](/guides/housing/moving-to-eindhoven-guide-2026/) guide has more detail.
...
I have also built a [BSN Appointment Planner tool](/tools/bsn-planner/) that tracks current approximate wait times across Dutch municipalities. Check it before you book — it can help you decide whether to wait or to see if a nearby gemeente has a shorter queue (though remember you must register where you actually live).
...
See my guide to the [best bank accounts for expats in the Netherlands](/guides/finance/best-bank-account-expats-netherlands-2026/) for a detailed comparison.
...
My [health insurance guide for expats](/guides/health/dutch-health-insurance-guide-expats-2026/) covers all the insurers, price comparison, and supplementary coverage options.
...
<a href="https://wise.com/invite/ihpc/willemt52" rel="nofollow sponsored" target="_blank">Wise (formerly TransferWise)</a> accounts do not require a BSN. You can open one with just your passport, and you get a European IBAN that can receive salary payments, pay Dutch invoices, and handle international transfers at competitive rates.
...
<a href="https://wise.com/invite/ihpc/willemt52" rel="nofollow sponsored" target="_blank">Open a Wise account for international transfers →</a>
...
- [DigiD guide for expats](/guides/legal/digid-guide-expats-2026/) — your digital identity for all Dutch government services
- [Dutch health insurance guide](/guides/health/dutch-health-insurance-guide-expats-2026/) — how to choose and register for basisverzekering
- [Best bank accounts for expats in the Netherlands](/guides/finance/best-bank-account-expats-netherlands-2026/) — where to open your Dutch account and how quickly you can do it
- [30% ruling guide](/guides/finance/30-percent-ruling-netherlands-2026/) — the tax benefit for highly skilled migrants, and how to apply before the deadline
- [Complete guide to moving to the Netherlands](/guides/legal/complete-guide-moving-to-netherlands-2026/) — the full sequence of steps before and after arrival
- [Highly skilled migrant visa guide](/guides/legal/highly-skilled-migrant-visa-netherlands-2026/) — the IND residence permit process for knowledge workers
- City-specific guides: [Amsterdam](/guides/housing/moving-to-amsterdam-guide-2026/) | [Rotterdam](/guides/housing/moving-to-rotterdam-guide-2026/) | [The Hague](/guides/housing/moving-to-the-hague-guide-2026/) | [Utrecht](/guides/housing/moving-to-utrecht-guide-2026/) | [Eindhoven](/guides/housing/moving-to-eindhoven-guide-2026/)
