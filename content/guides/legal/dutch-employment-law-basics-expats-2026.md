...
For a detailed breakdown of Dutch employment contracts, see our [Dutch employment contract explained guide](/guides/work/dutch-employment-contract-explained-2026/).
...
1. **Transitievergoeding from day one** — replaced the old system where severance was only paid after 2+ years
2. **Ketenregeling (chain rule)** — maximum 3 fixed-term contracts over 3 years before permanent contract required; gap to reset the chain extended from 3 to 6 months
3. **Stricter dismissal grounds** — the current system of specific "grounds" (a-h) for dismissal
4. **Aanzegplicht** — employer must notify employee at least 1 month before end of fixed-term whether it will be renewed
5. **Transitievergoeding calculation reform** — simplified to 1/3 monthly salary per year
...
1. **Do not sign anything immediately.** You are not legally required to sign a settlement agreement (vaststellingsovereenkomst) at the moment of notification. Take time to review it carefully.

2. **Get the notification in writing.** Ask for written confirmation of the termination, the reason given, and the proposed timeline.

3. **Check whether the proeftijd had expired.** If you are being dismissed and your proeftijd was still running, the employer has wider rights but must still dismiss in writing.

4. **Identify the dismissal ground.** Is this economic (UWV route)? Is it a court application? Is it instant dismissal (ontslag op staande voet)? The route matters for your rights.
...
The Netherlands does not have a general statutory right to annual salary increases, but many CAOs mandate specific increases. In a tight labour market, salary negotiation is accepted and expected — see our [salary negotiation guide for expats](/guides/work/salary-negotiation-netherlands-expats-2026/).

---

## Useful Links

- [Dutch employment contract explained](/guides/work/dutch-employment-contract-explained-2026/)
- [Salary negotiation in the Netherlands for expats](/guides/work/salary-negotiation-netherlands-expats-2026/)
- [Remote work in the Netherlands — thuiswerkvergoeding and ARBO](/guides/work/remote-work-netherlands-expats-2026/)
- [Freelancer ZZP guide Netherlands](/guides/work/freelancer-zzp-guide-netherlands-2026/)
- [Dutch tax system overview](/guides/finance/dutch-tax-system-expats-guide-2026/)
- [30% ruling guide](/guides/finance/30-percent-ruling-netherlands-2026/)
- [DigiD guide — accessing UWV online](/guides/legal/digid-guide-expats-2026/)
- [BSN registration guide](/guides/legal/bsn-registration-guide-2026/)
- [UWV official website](https://www.uwv.nl)
- [Rijksoverheid employment law information](https://www.rijksoverheid.nl/onderwerpen/ontslag)
- [FNV trade union](https://www.fnv.nl)
