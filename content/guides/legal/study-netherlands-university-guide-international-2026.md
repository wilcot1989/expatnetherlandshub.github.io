...
This guide focuses on the university system itself: choosing programmes, admissions, tuition, and academic life. For the practical legal side — visas, residence permits, BSN registration, and your first 30 days — read the [student expat guide for the Netherlands](/guides/legal/student-expat-guide-netherlands-2026/).
...
Admission is competitive. Master's programmes in architecture and industrial design routinely receive 10-20 applicants per place. Deadlines typically run January-April for September intake. The [city of Delft](/guides/housing/moving-to-delft-guide-2026/) is a strong choice for student life — quieter than Amsterdam, significantly cheaper, and exceptionally well connected.
...
Amsterdam is the most expensive Dutch student city by a significant margin. Expect to pay €800-1,100 for a private room. The [Amsterdam housing market](/guides/housing/moving-to-amsterdam-guide-2026/) is particularly brutal for students — starting your housing search the moment you apply, not after you are accepted, is not excessive.
...
Rotterdam is significantly more affordable than Amsterdam — rooms run €550-850 — and the [city's](/guides/housing/moving-to-rotterdam-guide-2026/) energy and multicultural character make it a compelling place to study. Erasmus also has a strong alumni network in the Netherlands, which matters for post-study employment.
...
All applications to Dutch WO universities go through [Studielink](https://www.studielink.nl/), the national application portal. The process:

1. Create a Studielink account using your DigiD (Dutch citizens) or foreign ID
2. Select your programme(s) — you can apply to multiple programmes
3. Studielink passes your application to the university
4. The university contacts you directly for additional documents (transcripts, CV, motivation letter, language scores)
5. The university issues an admission decision independently
...
- Secondary school diploma equivalent to the Dutch VWO (pre-university education): Nuffic provides a [country-by-country evaluation](https://www.nuffic.nl/en/diploma-recognition)
...
The [diploma evaluator tool](/tools/diploma-evaluator/) on this site can give you a quick indication of whether your qualifications are likely to meet WO admission standards.
...
[DUO studiefinanciering](/guides/finance/duo-student-finance-international-students-2026/) is the Dutch government student support system. It provides:
...
See the full [housing guide for expats](/guides/housing/finding-housing-netherlands-expats-2026/) for general Netherlands rental market context. The student market has some specific dynamics — particularly the concentration in September and January — but the general platform and scam-avoidance advice applies.
...
- Daily life becomes significantly easier with Dutch — particularly for [finding housing](/guides/housing/finding-housing-netherlands-expats-2026/), navigating bureaucracy, and building non-student social connections
...
For the full picture on work permits and residency after graduation, read the [work permits guide](/guides/legal/netherlands-work-permit-non-eu-2026/).
...
These figures assume you are not in university-linked student housing (which would lower accommodation costs significantly). Use the [cost of living calculator](/tools/cost-of-living-calculator/) for a personalised breakdown.
...
For your first weeks, <a href="https://wise.com/invite/ihpc/willemt52" rel="noopener nofollow sponsored" class="cta-affiliate">Wise</a> is ideal: you can open a Wise account before you arrive in the Netherlands, receive money from your home country at real exchange rates, and pay Dutch expenses via a Wise debit card while you wait for your Dutch bank account. This avoids the expensive currency conversion charges that high-street banks typically apply to foreign cards.
...
**Arrival:**
- Register at gemeente within five days to get [BSN number](/guides/legal/bsn-registration-guide-2026/)
- Take out Dutch health insurance within four months of registering
- Get [OV-chipkaart](/guides/daily-life/ov-chipkaart-guide-expats-2026/) for public transport
...
Use <a href="https://wise.com/invite/ihpc/willemt52" rel="noopener nofollow sponsored" class="cta-affiliate">Wise</a> for managing money before your Dutch bank account is set up, and read the [student expat guide](/guides/legal/student-expat-guide-netherlands-2026/) for the full legal and administrative picture.
