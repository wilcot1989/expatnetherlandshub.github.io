...
Non-EU nationals — which includes citizens of the UK (post-Brexit), US, Canada, India, and most of the rest of the world — need authorisation to work in the Netherlands. The main forms of that authorisation are:

- **GVVA** — Gecombineerde Vergunning voor Verblijf en Arbeid (combined residence and work permit)
- **TWV** — Tewerkstellingsvergunning (standalone work permit)
- **Highly skilled migrant residence permit** — the kennismigrant route, which is technically a residence permit with full work rights built in

Understanding which one applies to you is the starting point.

## TWV vs GVVA: The Key Difference

| | **TWV** | **GVVA** |
|--|---------|---------|
| **What it covers** | Work authorisation only | Work + residence in one document |
| **Who applies** | Employer, via UWV | Employer, via IND |
| **Who uses it** | Short stays under 90 days, posted workers | Most non-EU workers staying 90+ days |
| **Processing time** | ~5 weeks | 8-12 weeks |
| **Cost** | €320 (employer pays) | €210 MVV + IND residence permit fee (employer pays) |
| **Tied to employer?** | Yes | Yes |
| **Right to bring family?** | No (standalone TWV only) | Yes (via dependent permit) |

### When You Need a TWV Only

A standalone TWV applies in limited situations — most commonly for workers staying fewer than 90 days, seasonal agricultural workers, and certain cross-border posted workers. If you are being sent to the Netherlands by a non-Dutch company for a short-term project, this may be your route.

Practically speaking, most expats relocating to the Netherlands for longer-term employment will go through the GVVA process.

### When You Need a GVVA

If you are moving to the Netherlands for a job contract longer than 90 days, the GVVA is the standard route. It covers your right to live and work in the Netherlands in a single document, which simplifies things considerably.

The GVVA is initiated by your employer. You cannot apply for it yourself.

## The Highly Skilled Migrant Route (Kennismigrant): A Different Track

If your salary is high enough, you may be exempt from the standard TWV/GVVA process entirely. The highly skilled migrant (kennismigrant) route is faster, simpler, and does not require your employer to prove that no Dutch or EU worker was available for the role.

The salary thresholds for 2026 are:
...
Read the full breakdown in our [highly skilled migrant visa guide](/guides/legal/highly-skilled-migrant-visa-netherlands-2026/).

## Employer Responsibilities: What Your Company Must Do

In the Dutch work permit system, the employer carries most of the administrative weight — and most of the legal responsibility. Here is what your employer is required to do:

### 1. Register as a Recognised Sponsor (for HSM route) or File with UWV (for TWV/GVVA)

For the highly skilled migrant route, your employer must be an IND-recognised sponsor. You can check the [IND public register](https://ind.nl/en/public-register-recognised-sponsors) to verify this.

For the standard GVVA route, the employer files the work permit request with UWV (Uitvoeringsinstituut Werknemersverzekeringen) and the residence permit application with IND.

### 2. Demonstrate Labour Market Need (Prior Notification)

For most GVVA/TWV applications, the employer must show they made a genuine attempt to fill the role from the EU/EEA labour market first. This involves:

- Registering the vacancy with UWV at least five weeks before submitting the permit application
- Documenting recruitment efforts (job boards, recruitment agencies, interviews with EU candidates)
- Showing why EU/EEA applicants were not suitable

This requirement is waived for highly skilled migrants, intra-company transferees (ICT permit), researchers, and roles on the national shortage occupations list.

### 3. Submit the Application and Pay the Fees

The employer submits the application to IND and/or UWV and pays the associated fees. Employers cannot legally pass these costs to you. The fees in 2026 are approximately:

- **TWV via UWV:** €320
- **MVV (entry visa, if required):** €210
- **IND residence permit:** varies by permit type and duration

### 4. Maintain Compliant Employment Conditions

Throughout your employment, your employer is legally required to maintain the same salary and conditions that were stated in the permit application. Changing job titles, reducing hours, or adjusting salaries without updating the permit can result in fines or permit revocation.

## Required Documents: Your Checklist

**From the employer:**
- Completed UWV and/or IND application forms
- Employment contract (minimum 12 months recommended for GVVA)
- Company registration documents
- Evidence of recruitment efforts (for roles requiring labour market test)
- Employer declaration

**From you:**
- Valid passport (at least 6 months beyond intended stay)
- Passport photos (meeting Dutch biometric standards)
- Degree certificates with apostille or legalisation (where relevant)
- Criminal record certificate (VOG equivalent from your home country)
- TB test certificate (if you are from a country on the IND's TB-risk list)
- CV and any relevant professional certificates
- Birth certificate (for family applications)

For the apostille and legalisation requirements, see our [apostille and document legalisation guide](/guides/legal/apostille-legalization-netherlands-2026/).

After approval, you will need to register at your municipality (gemeente) and get your BSN number. See the [BSN registration guide](/guides/legal/bsn-registration-guide-2026/) for the full process.

## Timeline: What to Expect

The timeline for a standard GVVA (excluding the highly skilled migrant route) runs as follows:

| Stage | Who Does It | Time |
|-------|-------------|------|
| **Vacancy registration at UWV** | Employer | 5 weeks minimum before permit application |
| **UWV TWV decision** | UWV | ~5 weeks |
| **IND residence permit decision** | IND | 8-12 weeks (90-day legal max) |
| **MVV collection at Dutch embassy** | You | 1-2 weeks after approval |
| **Entry to Netherlands + registration** | You | Within 3 months of MVV issue |
| **Biometrics at IND desk** | You | Within 2 weeks of arrival |
| **Residence permit card received** | IND | 2-4 weeks after biometrics |

**Total from job offer to arrival:** Allow 3-4 months for a standard GVVA. This is why job offers in the Netherlands often come with a later start date than you might expect.

For the highly skilled migrant route, the total process from employer application to your arrival is typically 6-8 weeks.

## The MVV: Entry Visa Requirements

An MVV (Machtiging tot Voorlopig Verblijf) is a sticker placed in your passport at a Dutch embassy or consulate in your home country, allowing you to enter the Netherlands as a long-stay resident.

Not everyone needs an MVV. Citizens of the following countries are MVV-exempt:

- United States, Canada, Australia, New Zealand
- Japan, South Korea, Taiwan
- Most EU candidate countries
- Several others — check the [IND website](https://ind.nl) for the current list

If you do need an MVV, it must be collected from the Dutch embassy or consulate in your country of legal residence before you travel to the Netherlands. The MVV is valid for 90 days and gives you the right to enter — you then complete the process on arrival.

## Sector-Specific Rules

Work permit requirements and conditions vary across sectors:

### Healthcare and Education

Healthcare workers (nurses, doctors, therapists) and teachers often need additional credential recognition from Dutch professional bodies before their permit can be processed:

- **BIG register** (Beroepen in de Individuele Gezondheidszorg) for medical and allied health professionals
- **DUO credential recognition** for teachers

This can add 4-12 weeks to the overall timeline. Plan accordingly.

### Agriculture and Seasonal Work

Short-term agricultural workers typically use a simplified TWV process. The seasonal work permit allows stays of up to 24 weeks. There are specific bilateral agreements with countries in Eastern Europe and beyond.

### Intra-Company Transfers (ICT Permit)

If your company is sending you to its Dutch office from outside the EU, the ICT (Intra-Corporate Transfer) permit is a separate route. Requirements include:

- At least 3 months' continuous employment with the same company
- Role must be manager, specialist, or trainee
- Salary must meet minimum threshold (similar to highly skilled migrant rates)
- Stay up to 3 years (managers/specialists) or 1 year (trainees)

### Freelancers and Self-Employed

You cannot get a TWV or GVVA for self-employment. Freelancers and ZZP (zelfstandige zonder personeel) workers need a different residence permit — a self-employment visa. Read our [ZZP and freelancer guide](/guides/work/freelancer-zzp-guide-netherlands-2026/) for the full picture.

## Work Permit vs Residence Permit: A Common Point of Confusion

These are two different things that are often conflated:

- **Work permit (TWV):** Authorises you to perform paid work for a specific employer in the Netherlands
- **Residence permit:** Authorises you to live in the Netherlands

A GVVA combines both. A standalone TWV only covers work — you still need separate residence authorisation for stays over 90 days.

The highly skilled migrant (kennismigrant) permit is a residence permit that includes unrestricted work rights with the sponsoring employer. It is not technically a "work permit" in the TWV sense, which is part of why the terminology gets confusing.

If you are not sure which route applies to your situation, use our [visa and permit finder tool](/tools/visa-permit-finder/) for a personalised recommendation.

## Costs and Fees: Full Breakdown

| Fee | Who Pays | Amount (2026) |
|-----|----------|--------------|
| **TWV (UWV)** | Employer | €320 |
| **MVV** | Employer (typically) | €210 |
| **IND residence permit (GVVA)** | Employer | €320 |
| **IND residence permit (HSM)** | Employer | €320 |
| **Apostille/legalisation** | Employee | Varies by country (€50-€200+) |
| **Criminal record certificate** | Employee | Varies by country |
| **TB test** | Employee | ~€100-€150 |
| **Municipality registration (gemeente)** | Free | — |

Total out-of-pocket costs for the employee in a standard relocation are typically €200-€500 for document preparation. The core permit fees are covered by the employer.

## Protecting Yourself During the Gap Period
...
## Financial Benefits: The 30% Ruling

If you qualify as a highly skilled migrant, your employer may be able to apply for the **30% ruling** — a tax advantage that allows you to receive 30% of your gross salary tax-free for up to five years. This significantly reduces your Dutch income tax burden and can make a meaningful difference to your take-home pay.

To qualify, you must meet salary thresholds, have lived more than 150km from the Dutch border for at least 16 of the 24 months before arrival, and have a specific expertise that is scarce in the Dutch labour market.

Read the full conditions in our [30% ruling guide](/guides/finance/30-percent-ruling-netherlands-2026/).

## Checking Your Salary Against the Market

Before finalising your employment contract, it is worth understanding whether your offered salary is competitive for your role and sector in the Netherlands. Use our [salary checker tool](/tools/salary-checker/) to compare your offer against Dutch market data.

This matters not only for your personal finances but also for permit purposes: salary below the minimum thresholds is one of the most common reasons permit applications are delayed or refused.

## What Happens After Your Permit Expires?

A GVVA is typically issued for the duration of your employment contract, up to a maximum of 3 years, with renewal possible. When your permit is approaching expiry:

- Your employer must apply for renewal before the current permit expires
- You can continue working during the renewal period if the application was submitted on time
- If you change jobs, a new application is required before you start working

After 5 years of continuous legal residence, you can apply for a permanent residence permit or Dutch citizenship. Both routes require proof of integration — including the inburgeringsexamen at B1 Dutch language level for most permit types (though highly skilled migrants have a reduced inburgering obligation in practice).

For the full picture on working in the Netherlands, including employment contract rights and conditions, read our [Dutch employment contract guide](/guides/work/dutch-employment-contract-explained-2026/).

## Common Reasons Permit Applications Are Delayed or Refused

After working with dozens of expat clients through the Dutch permit process, I have seen the same problems come up repeatedly. Most delays and refusals are avoidable.

### 1. Salary Dips Below the Threshold

This sounds obvious, but it trips people up in practice. If your contract shows a base salary that meets the HSM threshold but you will be working part-time during an initial trial period, or if your gross salary includes variable components that the IND does not count toward the threshold (certain allowances, bonuses), you may be below the minimum without realising it. Always confirm with your employer that the fixed monthly salary — excluding holiday allowance — meets the IND threshold before submitting.

### 2. Employer is Not a Recognised Sponsor

If your employer applies for an HSM permit but has not yet obtained recognised sponsor status, the application will fail. Check the [IND public register](https://ind.nl/en/public-register-recognised-sponsors) before any application is submitted. If your employer is not on the list, they must apply for recognised sponsor status first — a process that takes 4-8 weeks and involves a separate IND assessment.

### 3. Missing or Non-Legalised Documents

Degree certificates and professional qualifications issued outside the EU must typically be apostilled or legalised to be accepted. A photocopy of your degree without an apostille is not enough. The requirements vary by country of issue — some countries are party to the Hague Convention on apostilles (simpler), while others require full consular legalisation (more time-consuming). Build 4-8 weeks into your timeline for document legalisation if needed.

### 4. Criminal Record Certificate from the Wrong Authority

The IND requires a criminal background check from your country of residence, not necessarily your country of birth. If you have been living in Germany for three years before moving to the Netherlands, you need a German certificate, not one from your home country. If you have recently left multiple countries, you may need certificates from each. This is one of the most commonly overlooked details.

### 5. TB Test Not Completed

Citizens of certain countries — primarily in sub-Saharan Africa, South and Southeast Asia, and parts of Latin America — must complete a TB (tuberculosis) test before receiving their MVV or residence permit. The IND publishes the full list. If you are from one of these countries and do not complete the test, your permit will not be issued regardless of how well the rest of the application was handled.

### 6. Labour Market Test Not Satisfied

For standard GVVA applications (not HSM), the UWV requires genuine evidence of prior recruitment effort. Employers who register the vacancy but cannot demonstrate actual interviews with rejected EU/EEA candidates — or who submitted the vacancy less than five weeks before the permit application — risk having the TWV refused. This delays the entire GVVA process by weeks.

### 7. Job Title or Description Mismatch

Your actual work must match the role description in the permit application. IND and UWV take this seriously — if you are hired as a "software engineer" but your work turns out to be primarily project management or client facing sales, this can create compliance issues at renewal. Make sure your employment contract accurately describes what you will be doing.

## After You Arrive: The First Steps

Once you are in the Netherlands with your MVV, the clock starts on several parallel tasks:

1. **Register at your gemeente within 5 days of arrival** — mandatory for all new residents. Read the [BSN registration guide](/guides/legal/bsn-registration-guide-2026/) for the full process
2. **Attend your IND biometrics appointment** — within the time frame specified in your approval letter (typically within 2 weeks of arrival)
3. **Arrange Dutch health insurance within 4 months of registration** — not optional. See the [Dutch health insurance guide](/guides/health/dutch-health-insurance-guide-expats-2026/)
4. **Start your inburgeringsexamen preparation if required** — not needed for highly skilled migrants, but check whether your permit type includes an integration obligation
...
For health cover during the working holiday period, <a href="https://go.expatnetherlandshub.com/safetywing?ref=/guides/legal/netherlands-work-permit-non-eu-2026/" target="_blank" rel="nofollow noopener sponsored">SafetyWing Nomad Insurance</a> is a flexible option — it can be started from your home country before you travel and continued month-to-month while you settle in. Once you are registered in the Netherlands and have a BSN, you will need to switch to a Dutch basisverzekering.
...
If you are already in the Netherlands on a student residence permit, you can apply for the orientation year before your student permit expires — allowing for a smooth transition.
...
If you have just started the process, the next step is sorting your housing and getting your BSN. Read our [partner visa guide](/guides/legal/partner-visa-netherlands-expats-2026/) if your partner is also relocating, and our [complete moving to Netherlands guide](/guides/legal/complete-guide-moving-to-netherlands-2026/) for the full relocation checklist.
