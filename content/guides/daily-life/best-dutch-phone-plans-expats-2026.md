...
This guide covers everything you need to know about Dutch mobile plans in 2026 — how the system works, which providers are worth your time, and which ones to skip.
...
**Prepaid** (in Dutch: *prepaid* or *beltegoed*) means you top up credit as you go. There is no monthly commitment. You can buy a prepaid SIM at Albert Heijn, Primera, Kruidvat or any phone shop — no BSN required, just a valid passport or ID card.

**Postpaid** (a monthly contract or *abonnement*) gives you a fixed bundle of data, calls and texts for a set monthly fee. You pay at the end of the month. Most contracts run month-to-month now, which is a big improvement from the two-year lock-ins that used to be standard. For a postpaid plan you will typically need a Dutch bank account and a [BSN number](/guides/legal/bsn-registration-guide-2026/) — so if you have just arrived and are still waiting for registration, prepaid is the sensible short-term choice.

### SIM-Only vs Phone + Plan

Dutch providers sell both SIM-only plans and bundled phone + plan deals. My honest advice: buy them separately. The bundled deals rarely offer good value, and you are often locked in for 24 months. Buy your handset outright and take a SIM-only plan. The Dutch market has excellent SIM-only prices — you can get 20 GB per month for under €15 without much trouble.

---

## The Three Main Networks

All Dutch mobile providers operate on one of three physical networks. Understanding this matters because coverage and data speeds depend entirely on which network your SIM sits on.

### KPN

KPN is the former state telecoms monopoly and still has the most extensive coverage in the Netherlands, particularly in rural areas. If you travel frequently outside the Randstad — the main urban cluster of Amsterdam, Rotterdam, The Hague and Utrecht — KPN's network is often the most reliable. It is also the only network with guaranteed indoor coverage in some of the older buildings I've lived in.

KPN sells directly under its own brand and also powers budget providers like Simyo and KPN Prepaid.

Price-wise, KPN's own plans are at the premium end. Expect to pay around €25–€35 per month for a decent data bundle on a direct KPN contract.

### T-Mobile / Odido

T-Mobile rebranded part of its operations as Odido in the Netherlands. The network is solid, particularly strong in cities, and has been aggressive on pricing. T-Mobile's 5G rollout is one of the furthest along in the country.

Several budget providers run on the T-Mobile network, including Ben and Simpel. If you are price-sensitive but want T-Mobile coverage, one of these MVNOs (mobile virtual network operators) is worth a look.

### Vodafone

Vodafone operates the third major network. Coverage is good in urban areas, somewhat less consistent in smaller towns and villages. Vodafone tends to be competitive on unlimited data plans and often runs promotional deals. It also powers a handful of smaller brands.

---

## Best Budget Providers

This is where most expats should be looking, honestly. The Dutch budget SIM market is very mature and you can get excellent value without sacrificing much.

### Simyo

Simyo runs on the KPN network and is one of my personal favourites for no-fuss expats. Plans start at around €8/month for a small data bundle, scaling up to €22/month for unlimited data. There are no contracts — everything runs month-to-month. The app is decent, porting a number in is simple, and customer service is better than you would expect for a budget brand.

If you want KPN coverage at a fraction of the price, Simyo is the place to start.

### Ben

Ben runs on T-Mobile's network and pitches itself at simple, low-cost plans. It is particularly popular with students and younger expats. Data bundles are competitively priced, and the sign-up process is easy — you can do it entirely online in English. Ben does not have the most extensive customer service, but if you are comfortable managing things yourself, it is a solid choice.

### Lebara

Lebara deserves a separate mention both here and in the international calling section below. It is a UK-founded brand (which means expats from the UK often already know it) with Dutch operations that have improved substantially over the past couple of years. Plans include generous bundles for international calls to a long list of countries. Data allowances are reasonable. For expats who call family abroad regularly, Lebara is hard to beat on price.

### Lycamobile

Lycamobile is the other big name in budget international calling. Plans can be extremely cheap — sometimes €5–€10/month for a bundle that includes calls to 70+ countries. Data speeds can vary, and the customer service is inconsistent, but for a temporary or backup SIM while you are getting settled, Lycamobile is worth considering.

---

## Best for Data: Odido / T-Mobile

If your priority is mobile data — you work remotely, you use your phone as a hotspot, or you just consume a lot of video — T-Mobile / Odido is currently the strongest option. Unlimited data plans on T-Mobile come in at around €25–€30/month, and the 5G speeds in Dutch cities are genuinely impressive. I tested speeds in Amsterdam Centraal recently and was getting north of 400 Mbps on 5G — more than enough for video calls and large file transfers.

T-Mobile also has decent roaming options within the EU, which matters if you travel regularly for work. EU roaming is legally required to be included in Dutch plans under EU rules, but the fair-use data caps vary between providers, and T-Mobile's caps are among the more generous.
...
As I mentioned above, Lebara is the go-to for affordable international calls. Their Dutch plans include free or heavily discounted calls to countries including India, Pakistan, the Philippines, Morocco, Turkey, the UK, the US and many more. The exact country list changes periodically, so check the current offer on their website. Data allowances have improved — their mid-tier plan now includes 15 GB, which is workable for most people.

### Lycamobile

Lycamobile covers a similarly long list of international destinations. The pricing is sometimes even lower than Lebara for certain call destinations, particularly to parts of Africa and Southeast Asia. The trade-off is that their Dutch data network can feel slower during peak hours, and their customer service reputation is patchy. I would use Lycamobile as a secondary SIM for international calls rather than a primary plan, unless calls are genuinely your main need.

---

## eSIM Options in the Netherlands

eSIM adoption in the Netherlands has accelerated over the past two years. All three major networks — KPN, T-Mobile and Vodafone — now offer eSIM activation, and several MVNOs do too, including Simyo and Ben.

The process is usually quick: sign up online, receive a QR code by email, scan it in your phone's settings, and you are live within minutes. No waiting for a physical SIM in the post.

A few things to check before you commit to an eSIM plan:

- **Device compatibility.** Not all handsets support eSIM. iPhone XS and later, Google Pixel 3 and later, and most recent Samsung Galaxy models do. Older or budget Android phones often do not.
- **Dual SIM.** Many people use eSIM for their Dutch number and keep a physical SIM for a foreign number. Most modern flagship phones support this combination.
- **Business accounts.** If you need an eSIM on a company account, check with the provider — some restrict eSIM to consumer plans only.

---

## Comparison Table

| Provider | Network | Monthly Price (mid-tier) | Data | Intl. Calls | eSIM | Contract |
|---|---|---|---|---|---|---|
| KPN | KPN | €30–€35 | 20–50 GB | Paid add-on | Yes | Month-to-month |
| Simyo | KPN | €15–€22 | 10–Unlimited | Paid add-on | Yes | Month-to-month |
| T-Mobile / Odido | T-Mobile | €25–€30 | Unlimited | EU included | Yes | Month-to-month |
| Ben | T-Mobile | €12–€20 | 10–25 GB | Paid add-on | Yes | Month-to-month |
| Vodafone | Vodafone | €28–€35 | 20–Unlimited | Paid add-on | Yes | Month-to-month |
| Lebara | Varies | €10–€18 | 5–15 GB | Included (70+ countries) | Limited | Month-to-month |
| Lycamobile | Varies | €5–€15 | 3–10 GB | Included (70+ countries) | No | Month-to-month |

*Prices correct as of April 2026. Always check the provider's website for current offers.*

---

## What Expats Specifically Need to Consider

Choosing a phone plan as an expat is slightly different from choosing one as a long-term resident. Here is what I always tell people who ask me for advice.

### How Long Are You Staying?

If you are here for less than six months, prepaid or a no-contract monthly plan is almost always better. The Dutch market is entirely month-to-month for most SIM-only plans now, so there is rarely a reason to lock in.

### Do You Have a BSN Yet?

As I mentioned earlier, some postpaid plans require a BSN. If you are still in the process of [registering with your municipality](/guides/legal/bsn-registration-guide-2026/) or setting up your [DigiD](/guides/legal/digid-guide-expats-2026/), a prepaid SIM bridges the gap nicely.

### What Is Your Budget?

Phone costs are one part of a larger picture. If you are working out your total [cost of living in the Netherlands](/guides/housing/cost-of-living-netherlands-2026/), mobile is relatively minor — but it is worth aligning with your overall spending plan. Most expats I know spend between €10 and €25 per month on mobile, depending on data needs.

### Do You Need a Dutch Bank Account?

Most monthly plans require a Dutch bank account for direct debit. If you have not sorted that yet, take a look at [the best bank accounts for expats](/guides/finance/best-bank-account-expats-netherlands-2026/) before signing up for a contract plan.

### Will You Use Your Phone as a Hotspot?

Working from cafes or travelling a lot? Make sure your plan explicitly allows tethering (hotspot use). Most Dutch plans do, but some budget ones restrict it or count hotspot data separately.

---

## Practical Tips

**Buy a prepaid SIM on day one.** You can pick up a KPN, T-Mobile or Lebara prepaid SIM at Schiphol airport or any Albert Heijn. It costs a few euros and gets you connected immediately while you sort everything else out.

**Port your number if you change providers.** You can transfer any Dutch mobile number between providers. It usually takes one working day and happens automatically. You do not lose your number.

**Check coverage maps honestly.** Every provider's coverage map makes their network look better than it is. If you live or work in a specific town or building, look for independent coverage checkers or ask locals what they use.

**Keep an eye on roaming.** If you travel within the EU for work, your Dutch plan includes EU roaming by default — but fair-use limits apply. Check your provider's roaming policy and keep an eye on data usage when abroad.

**Consider a VPN for public Wi-Fi.** If you use public hotspots regularly, a [VPN is worth having](/guides/daily-life/best-vpn-netherlands-expats-2026/) — it protects your data on open networks in cafes, co-working spaces and transit hubs.

**Compare using independent sites.** Dutch comparison sites like Belsimpel.nl and Mobiel.nl let you filter by data, price and network. They are useful for a quick market scan.

---

## How This Fits Into Your Broader Setup

A phone plan is usually one of the first things to sort when you arrive, but it sits alongside a few other practical steps. If you are still in the early stages of your move, the [complete guide to moving to the Netherlands](/guides/legal/complete-guide-moving-to-netherlands-2026/) covers the full picture — registration, healthcare, banking, housing.

You will also want to sort home internet separately. Mobile data is fine for day-to-day use, but Dutch home broadband is excellent and relatively affordable. I have written about the [best internet providers in the Netherlands](/guides/daily-life/best-internet-providers-netherlands-2026/) if you want to compare your options.

And if you are still figuring out which SIM card to buy first versus which plan to commit to longer-term, my [SIM card guide for expats](/guides/daily-life/best-sim-card-netherlands-expats-2026/) goes into more detail on the short-term options.

---

## My Recommendation by Situation

**Just arrived, no BSN yet:** Buy a Lebara or Lycamobile prepaid SIM at the airport or supermarket. Top up as needed until your registration comes through.

**Settled in, mainly need data:** Simyo on KPN or T-Mobile / Odido. Both offer excellent month-to-month unlimited plans at fair prices.

**Call family abroad regularly:** Lebara is the standout. Check their current country list and bundle your international calls into your monthly plan rather than paying per minute.

**Work remotely and need reliable coverage everywhere:** KPN direct or Simyo (KPN network) for the widest rural coverage. Worth paying slightly more if you travel outside the cities.

**Short stay, just need something cheap:** Lycamobile or a supermarket prepaid SIM. Spend €10, use it for a few months, done.
...
Or compare phone and telecom plans side by side: <a href="https://go.expatnetherlandshub.com/independer-telecom" class="cta-affiliate" rel="nofollow noopener sponsored" target="_blank">Compare Telecom Plans at Independer</a>
