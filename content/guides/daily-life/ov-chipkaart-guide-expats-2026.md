...
| Type | Cost | Who Can Use It | Subscriptions | OV-fiets |
|------|------|---------------|---------------|----------|
| **Personal** | EUR 7.50 | Registered owner only | Yes | Yes |
| **Anonymous** | EUR 7.50 | Anyone | No | No |
| **Disposable** | EUR 1-2 (single use) | Anyone | No | No |
...
Before you pick a subscription, it helps to know how your transport costs fit into your total monthly budget. Our cost-of-living tools can help you model that.

<a href="/tools/" class="cta-affiliate">Explore our expat budget tools →</a>

## NS Trains: The National Rail Network
...
### Most Popular NS Flex Subscriptions

| Subscription | Monthly Cost | Discount | Best For |
|-------------|-------------|----------|----------|
| **Dal Voordeel** | ~EUR 5.50 | 40% off-peak | Weekend travelers, flexible workers |
| **Altijd Voordeel** | ~EUR 27 | 40% off-peak, 20% peak | Regular commuters, 2-3 days/week |
| **Dal Vrij** | ~EUR 110 | Unlimited off-peak travel | Frequent off-peak travelers |
| **Traject Vrij** | Varies by route | Unlimited on one route | Daily commuters on a fixed route |
| **Altijd Vrij** | ~EUR 360 | Unlimited all travel | Daily commuters, multiple routes |
...
| City | Operator | Modes | Website |
|------|----------|-------|---------|
| **Amsterdam** | GVB | Tram, bus, metro, ferry | gvb.nl |
| **Rotterdam** | RET | Tram, bus, metro | ret.nl |
| **The Hague** | HTM | Tram, bus | htm.nl |
| **Utrecht** | U-OV (Qbuzz) | Tram, bus | u-ov.info |
| **Other regions** | Arriva, Keolis, EBS, Connexxion | Bus, regional train | Varies |
...
Most stations offer free public WiFi. It is convenient for checking routes and delays, but station networks are shared and unencrypted — not suitable for banking or work logins without protection. <a href="https://go.nordvpn.net/aff_c?offer_id=612&aff_id=141337&url_id=14830" rel="noopener nofollow sponsored" target="_blank">Stay secure on public WiFi with NordVPN →</a>
...
| Expense | Public Transport | Car |
|---------|-----------------|-----|
| Monthly commute (30 km each way) | ~EUR 200-350 (with subscription) | ~EUR 300-500 (fuel, insurance, tax, parking) |
| Parking | Not applicable | EUR 100-300/month in cities |
| Insurance | Not applicable | EUR 50-100/month |
| Maintenance | Not applicable | EUR 50-100/month |
| Flexibility | Great in Randstad, limited in rural areas | Flexible everywhere |
...
| Feature | OVpay (Bank Card) | OV-chipkaart |
|---------|-------------------|--------------|
| Subscriptions | No | Yes |
| OV-fiets | No | Yes (personal card) |
| Automatic top-up | Not needed | Available |
| Tourist-friendly | Yes | Requires purchase |
| Discount products | Limited | Full range |
| Day cap pricing | Yes | With subscriptions |
