...
| Phase | Months | Tax-Free Percentage | Notes |
|-------|--------|---------------------|-------|
| Phase 1 | Months 1–20 (~years 1 and 2) | **30%** | Maximum benefit; best time to build savings |
| Phase 2 | Months 21–40 (~years 3 and 4) | **20%** | Noticeable drop; plan ahead |
| Phase 3 | Months 41–60 (year 5) | **10%** | Minimal benefit; consider optimising pension/investments before expiry |
...
| Phase | Tax-Free Allowance | Taxable Salary | Approximate Income Tax | Approximate Annual Saving vs No Ruling |
|-------|-------------------|----------------|------------------------|----------------------------------------|
| Phase 1 (30%) | EUR 30,000 | EUR 70,000 | ~EUR 24,500 | ~EUR 14,800 |
| Phase 2 (20%) | EUR 20,000 | EUR 80,000 | ~EUR 28,500 | ~EUR 10,800 |
| Phase 3 (10%) | EUR 10,000 | EUR 90,000 | ~EUR 32,200 | ~EUR 7,100 |
...
Use my [30% ruling calculator](/tools/30-percent-ruling-calculator/) to model all three phases against your actual salary.
...
For managing foreign accounts and transferring money internationally, a multi-currency account like <a href="https://wise.com/invite/ihpc/willemt52" target="_blank" rel="noopener nofollow sponsored" class="cta-affiliate">Wise →</a> keeps costs down when moving funds between your Dutch and home-country accounts.
...
For a deeper explanation with examples, see the dedicated section below: [Partial Non-Resident Status (Box 3) Explained](#partial-non-resident-status-box-3-explained).
...
For help managing international finances during your time in the Netherlands, a multi-currency account like <a href="https://wise.com/invite/ihpc/willemt52" rel="noopener nofollow sponsored" target="_blank">Wise</a> can be useful for handling money in multiple countries. See our [complete guide to moving to the Netherlands in 2026](/guides/legal/complete-guide-moving-to-netherlands-2026/) for more on setting up your financial life.
...
<a href="https://wise.com/invite/ihpc/willemt52" class="cta-affiliate" rel="noopener nofollow sponsored" target="_blank">Manage Your International Finances with Wise</a>
...
The effective average over the full five years under the step-down model is 20%, not 30%. This distinction matters enormously for financial planning. Use my [30% ruling calculator](/tools/30-percent-ruling-calculator/) to model the actual impact year by year.
