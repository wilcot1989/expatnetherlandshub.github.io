...
For more context on how Dutch salaries are structured, read my guide on [Dutch employment contracts explained](/guides/work/dutch-employment-contract-explained-2026/). Understanding what is in your gross salary is important before you run the numbers.
...
If you have moved to the Netherlands but your employer is a company based in, say, the UK or US, and they do not have a Dutch payroll, you do not qualify for the 30% ruling. For this situation, you would typically be taxed through a different mechanism. Read my guide on [the Dutch tax system for expats](/guides/finance/dutch-tax-system-expats-guide-2026/) for more detail on how different employment structures are taxed.
...
### "I moved from the UK for a job offer." → YES (almost certainly)
...
### "I moved from Belgium." → PROBABLY NOT
...
### "I came as a student, stayed in NL, then got a job." → PROBABLY NOT
...
### "I already lived in the Netherlands for a year, then got a new job." → NO
...
### "I am a self-employed freelancer / ZZP'er." → NO

There is no route to the 30% ruling as a self-employed person. You must have a formal employment relationship with a Dutch employer. This is a firm rule with no exceptions. If you are weighing up becoming self-employed versus taking an employed role, factor this in carefully. For self-employed workers, the [cost of living in the Netherlands](/guides/housing/cost-of-living-netherlands-2026/) without the 30% benefit is considerably more burdensome.
...
### "I want to renegotiate my salary to include the 30% ruling." → THIS IS WORTH DOING
...
Read my guide on [salary negotiation for expats in the Netherlands](/guides/work/salary-negotiation-netherlands-expats-2026/) before your contract discussion. This is one of the most valuable conversations you can have before signing.
...
As soon as you accept a job offer, tell your HR team or payroll manager that you want to apply for the 30% ruling. Do not assume they will do it automatically. Some HR departments are experienced with this; others are not.
...
Your employer submits the Verzoek loonheffingen 30%-faciliteit (the official application form) to the Belastingdienst. This should be done within 4 months of your employment start date. The application can be submitted electronically through the employer's payroll portal.

**Step 4 — Belastingdienst processes the application.**
Processing typically takes 6–10 weeks. During this time, your employer will continue deducting the standard wage tax from your salary. Once approved, the ruling is applied retroactively to your employment start date (provided the application was submitted within the 4-month window).

**Step 5 — You receive a tax ruling letter.**
The Belastingdienst issues a beschikking (official decision) confirming the ruling, the start date, and the end date. Keep this document. You will need it when you file your annual tax return, change employers, or if you are ever audited.

**Step 6 — Employer adjusts your payslip.**
From the first month following approval (and retroactively back to your start date), your employer will adjust your payslip to reflect the 30% tax-free allowance. Your monthly take-home pay increases noticeably.

For a complete understanding of how Dutch taxes work once you are here, read my guide on [filing your expat tax return in the Netherlands](/guides/finance/expat-tax-return-netherlands-2026/).
...
For a full breakdown of how these changes affect your total savings calculation, see my [complete 30% ruling guide](/guides/finance/30-percent-ruling-netherlands-2026/).

---

## The Financial Reality: Planning Around the 30% Ruling

Because the 30% ruling is not guaranteed until approved, I always advise clients to do their financial planning in two scenarios: one with the ruling, and one without.
...
When you are planning your move, you will also want to model your full cost of living. The [cost of living calculator](/tools/cost-of-living-calculator/) lets you compare cities and see how much disposable income you would actually have — with and without the ruling. Also verify your expected salary meets the threshold using the [salary checker tool](/tools/salary-checker/).
...
<a href="https://go.expatnetherlandshub.com/wise?ref=/guides/finance/30-percent-ruling-eligibility-guide-2026/" target="_blank" rel="nofollow noopener sponsored" class="cta-affiliate">Open a Wise account for international transfers →</a>
...
For a broader picture of expat finances in the Netherlands — including how to understand your payslip, file your tax return, and manage your benefits — read my [complete Dutch tax system guide](/guides/finance/dutch-tax-system-expats-guide-2026/).
...
1. **Are you being hired by a company with a Dutch payroll?**
   - No → You do not qualify. Stop here.
   - Yes → Continue.

2. **Were you recruited while living abroad, OR hired within 4 months of arriving in the Netherlands?**
   - No → You do not qualify. Stop here.
   - Yes → Continue.
...
4. **Was your previous residential address more than 150km from the Dutch border?**
   - Not sure → Check your address precisely. Do not assume.
   - Yes → Continue to Step 5.
   - No → Continue to Step 5a.

5. **Did you spend at least 16 of the 24 months before your Dutch employment start date living more than 150km from the Dutch border?**
...
The 30% ruling is one of the most valuable financial benefits available to expats in the Netherlands. Over five years, it can save you EUR 40,000–EUR 60,000 or more depending on your salary. But it is not automatic, it is not guaranteed, and it has enough edges and conditions that I strongly recommend getting specific advice before building your budget around it.
