...
- Fiscal partners (couple): **€114,000** (each partner's €57,000)

**Deemed return rates for 2026 (approximate):**

| Asset Category | Deemed Return Rate |
|---|---|
| Bank savings (spaartegoeden) | ~1.03% |
| Investments (beleggingen) | ~6.04% |
| Other assets incl. property | ~6.04% |
| Debts (deductible at) | ~2.47% |
...
**Step 1 — Taxable wealth:**
€100,000 total − €57,000 threshold = **€43,000 taxable**

**Step 2 — Apply deemed return:**
€43,000 × 1.03% (savings rate) = **€443 deemed return**

**Step 3 — Apply tax rate:**
€443 × 36% = **€159 Box 3 tax**

The amount is modest. The savings deemed return of 1.03% is intentionally low to reflect that savings accounts earn relatively little. If that same €100,000 were in an investment portfolio instead, the tax would be dramatically higher — see Example 2 for why.
...
**Step 1 — Taxable wealth:**
€200,000 total − €57,000 threshold = **€143,000 taxable**

Now I need to allocate the taxable €143,000 between savings and investments proportionally.

The ratio of savings to investments in the total portfolio is:
- Savings: €80,000 / €200,000 = 40%
- Investments: €120,000 / €200,000 = 60%

Applied to the taxable €143,000:
- Savings portion: €143,000 × 40% = **€57,200**
- Investment portion: €143,000 × 60% = **€85,800**

**Step 2 — Apply deemed returns:**
- Savings: €57,200 × 1.03% = €589
- Investments: €85,800 × 6.04% = €5,182
- **Total deemed return: €5,771**

**Step 3 — Apply tax rate:**
€5,771 × 36% = **€2,078 Box 3 tax**

This is a meaningful amount — and it will be owed regardless of whether your investments actually returned 6.04% or went down in value. That is the sting of the deemed return system.
...
**Step 1 — Combined taxable wealth:**
€250,000 total − €114,000 threshold (both partners) = **€136,000 taxable**

Let us say you split 50/50 on your tax returns: each of you declares €68,000 taxable wealth.

**For each partner — proportional allocation:**
Savings proportion of total assets: €100,000 / €250,000 = 40%
Investment proportion: €150,000 / €250,000 = 60%

Each partner's €68,000 split:
- Savings portion: €68,000 × 40% = €27,200
- Investment portion: €68,000 × 60% = €40,800

**Deemed returns per partner:**
- Savings: €27,200 × 1.03% = €280
- Investments: €40,800 × 6.04% = €2,464
- Total deemed return per partner: €2,744

**Box 3 tax per partner:** €2,744 × 36% = **€988**
**Combined household tax:** €988 × 2 = **€1,976**

Compare this to Example 2 where a single person with €200,000 mixed assets paid €2,078. The couple with €250,000 total pays slightly less in combined tax — the doubled threshold does significant work when assets are spread across two partners.
...
- **Green fund investments up to €71,251:** Investments in officially approved green funds (groene beleggingen) are exempt up to this amount per person.
...
While working toward a full reform, the government introduced a modified deemed return system that uses **actual average market returns** for each asset category (savings, investments) rather than flat fixed percentages. This is why the 2026 rates — 1.03% for savings, 6.04% for investments — are notably different from each other and change each year. They reflect what the average Dutch saver or investor actually earned in the relevant period.

This is still a deemed return system — it is not your actual return, it is the average. If you had a terrible year in the market and your investments dropped, you still pay tax based on the 6.04% average. If your savings account offered an unusually high rate, you still only pay on 1.03%.

### The Actual Return System (Werkelijk Rendement, Planned 2027)

The Dutch government is planning to replace the deemed return system entirely with taxation of **actual returns** from 2027 onward. Under this plan:
- Investment gains, dividends, and interest would be taxed as actually earned
- Capital appreciation would be taxed (though whether on realisation or an annual basis is still being debated)
- Rental income from Box 3 properties would be taxed on actual rent received

The 2027 target has already shifted once. As of mid-2026, the legislative process is ongoing. The move to actual return taxation will significantly change Box 3 planning strategies — particularly for expats with property in Box 3 or portfolios with high unrealised gains. I will update this guide as the legislation progresses.
...
The Dutch government maintains a list of approved green investment funds that invest in projects like sustainable energy, nature conservation, and organic agriculture. Investments in these funds up to **€71,251 per person** (€142,502 for fiscal partners) are completely exempt from Box 3. There is also an additional 0.7% tax credit on the exempt amount.
...
This is particularly useful for ZZP/freelancers who do not have employer pension accrual. For more on pension options, see the [Dutch pension guide for expats](/guides/finance/dutch-pension-complete-guide-expats-2026/).
...
1. Log in to [Mijn Belastingdienst](https://www.belastingdienst.nl) using your DigiD
2. Open your aangifte for the relevant year
...
In 2026, the tax-free threshold is €57,000 per person. On €100,000 savings, your taxable wealth is €43,000. Applying the deemed savings return of ~1.03% gives a deemed return of €443. At the 36% tax rate, you owe approximately €159 in Box 3 tax. The amount is modest for savings-heavy portfolios because the savings deemed return (1.03%) is much lower than the investment deemed return (6.04%).
...
The Dutch government is working toward a new system based on actual returns (werkelijk rendement) rather than deemed returns. Current target is 2027, though the timeline has already shifted once. Until then, the 2026 system uses updated deemed returns that more closely reflect actual market averages — savings at ~1.03%, investments at ~6.04%. If the 2027 implementation goes ahead, investment returns, dividends and rental income will be taxed as actually earned.
