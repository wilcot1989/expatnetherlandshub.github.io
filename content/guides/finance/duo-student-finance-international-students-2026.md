...
Every student enrolled at an accredited Dutch institution who wants to access any form of government student support goes through DUO. The application is made via [MijnDUO](https://mijn.duo.nl), DUO's online portal.

For practical registration steps before you can access any Dutch government services — including DUO — read our [BSN registration guide](/guides/legal/bsn-registration-guide-2026/) first. You need a BSN before you can apply.
...
For the full picture on your visa and residency status as a student, our [student expat guide](/guides/legal/student-expat-guide-netherlands-2026/) covers the residence permit requirements in detail.
...
| Living situation | Monthly amount (2026) |
|-----------------|----------------------|
...
These amounts are reviewed and adjusted annually. Check [DUO.nl](https://www.duo.nl) for the current year's figures before applying.
...
The OV-chipkaart system is explained in detail in our [OV-chipkaart guide](/guides/daily-life/ov-chipkaart-guide-expats-2026/), which covers how to use it, how to top up, and how to handle common problems.
...
| Category | Maximum per month |
|----------|-------------------|
| EU students | EUR 1,091 |
| Non-EU students | EUR 1,091 |
...
DUO student loans carry interest, set annually by the government. The rate in 2026 is low by historical standards but has increased from the near-zero rates of 2020–2022. Check DUO's current rate on [duo.nl](https://www.duo.nl).
...
The application process is entirely online through [MijnDUO](https://mijn.duo.nl). You need:

1. **BSN (Burger Service Nummer)** — your Dutch social security number. See our [BSN registration guide](/guides/legal/bsn-registration-guide-2026/).
2. **DigiD** — your Dutch digital identity. You create this at [digid.nl](https://www.digid.nl). It requires a BSN and a Dutch phone number.
...
1. Go to [mijn.duo.nl](https://mijn.duo.nl) and log in with DigiD
...
DUO pays into a Dutch bank account. You can in principle provide a foreign IBAN, but Dutch banks are strongly recommended to avoid transfer delays and fees. Our [best Dutch banks for students guide](/guides/finance/best-dutch-banks-students-young-expats-2026/) compares the main options for students, and our [best bank account for expats guide](/guides/finance/best-bank-account-expats-netherlands-2026/) covers broader options.
...
<a href="https://wise.com/invite/ihpc/willemt52" target="_blank" rel="noopener nofollow sponsored" class="cta-affiliate">Manage your DUO payments with Wise →</a>
...
Receiving DUO grants and working 56+ hours/month means you have income to declare. See our [Dutch tax system guide](/guides/finance/dutch-tax-system-expats-guide-2026/) for how student income is treated and what deductions students can claim.
...
| Cost | Monthly estimate (2026) |
|------|------------------------|
| Rent (shared student room, major city) | EUR 600–900 |
| Groceries | EUR 200–300 |
| Health insurance | EUR 130–170 |
| Phone + internet | EUR 30–50 |
| Leisure/social | EUR 100–200 |
| **Total** | **EUR 1,060–1,620** |
...
Once you graduate and start working in the Netherlands, your DUO repayments depend on your income. Use our [Salary Checker](/tools/salary-checker/) to understand your expected gross and net income, which feeds directly into how much you will repay on your DUO loan each month.
