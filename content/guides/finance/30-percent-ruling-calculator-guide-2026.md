...
If you just want the numbers fast, [try our 30% ruling calculator](/tools/30-percent-ruling-calculator/) — it runs the comparison instantly for your salary. If you want to understand what is happening behind the calculation, read on.
...
I have a full guide on eligibility, the application process, and the 2024 rule changes in [The 30% Ruling in the Netherlands 2026: Complete Guide](/guides/finance/30-percent-ruling-netherlands-2026/). If you are still checking whether you qualify, start there. This article assumes you are eligible and focuses on the financial calculation.
...
[Use our calculator](/tools/30-percent-ruling-calculator/) to get the full picture including social security deductions for your specific salary.
...
For the most precise figure for your salary, including pension contributions, holiday allowance, and the general tax credit (algemene heffingskorting), [run the full calculation in our tool](/tools/30-percent-ruling-calculator/).

To understand where your salary sits in the broader Dutch labour market, check the [average salary Netherlands guide](/guides/work/average-salary-netherlands-2026/).
...
The [30% ruling: is it still worth it in 2026?](/guides/finance/30-percent-ruling-still-worth-it-2026/) article goes deeper on the step-down changes and whether the ruling still makes financial sense for applicants starting now.
...
For eligibility questions — particularly the 150km rule and the specific expertise requirement — the [30% ruling eligibility guide](/guides/finance/30-percent-ruling-eligibility-guide-2026/) covers the detail. If you are freelancing through a ZZP structure, the [ZZP freelancer guide Netherlands](/guides/work/freelancer-zzp-guide-netherlands-2026/) covers whether and how the ruling can be accessed through that route.
...
The combination of these elements means the net saving is always slightly different from the straight tax calculation above. [Our 30% ruling calculator](/tools/30-percent-ruling-calculator/) accounts for all of these variables and produces a monthly and annual net income comparison you can put directly in a spreadsheet.
...
Not through the standard route. The ruling requires a formal employment relationship. As a ZZP freelancer, you do not qualify unless you are employed through a payroll or umbrella company. The [ZZP guide](/guides/work/freelancer-zzp-guide-netherlands-2026/) covers the options available to freelancers in the Netherlands.

### What happens if I switch jobs?

Your 30% ruling does not transfer automatically. Your new employer must submit a fresh application within 4 months of your start date, and there must be no gap longer than 3 months between your old and new roles. The remaining duration of your original 5-year period carries over. See the [complete 30% ruling guide](/guides/finance/30-percent-ruling-netherlands-2026/) for the transfer process in detail.
