...
An emergency fund is boring. It sits in an account doing very little. That is exactly what makes it valuable.
...
| Category | Typical Expat Range (2026) |
|---|---|
...
| Minimum debt repayments | Variable |
...
|---|---|
| Permanent contract, single income | 4-6 months |
| Permanent contract, dual income household | 3-4 months |
| Temporary or fixed-term contract | 6-9 months |
| ZZP/freelance | 9-12 months |
| ZZP with variable or seasonal income | 12+ months |
...
All Dutch banks offer standard savings accounts (spaarrekeningen). As of mid-2026:

| Bank | Savings rate (indicative) | Min. balance | Accessibility |
|---|---|---|---|
| ING | 1.6-2.0% | None | 1 business day |
| ABN AMRO | 1.4-1.8% | None | 1 business day |
| Rabobank | 1.5-2.0% | None | 1 business day |
| Triodos | 1.0-1.5% | None | 1 business day |

*Rates are variable and change with ECB policy. Always check current rates before opening.*
...
bunq is the Dutch neobank that has become popular among expats for its English-language interface and modern features. Their Easy Savings product offers competitive interest rates and instant access.

Key features of bunq Easy Savings:
- Available in the bunq app (Easy Money or Easy Green subscription)
- Interest typically 1-2% on available savings (rate varies)
...
Raisin (known as WeltSparen in Germany) operates a platform that lets you access savings accounts at banks across Europe from a single interface. This is useful when Dutch rates are low and other EU banks offer better rates.

How it works:
1. Open a Raisin account (free)
2. Browse offers from partner banks in Germany, Spain, Latvia, Portugal, etc.
...
Fixed-term deposits (e.g., 6 months, 1 year) via Raisin often offer higher rates than instant-access accounts — but these are not appropriate for the core emergency fund, which must remain accessible. Use Raisin for the portion of your savings beyond your immediate emergency fund, or for a "tier 2" buffer you could access within a few weeks.
...
**Tax-free threshold (heffingvrij vermogen)**: Approximately €57,000 per person, €114,000 for tax partners. If your total Box 3 assets (savings + investments, excluding your primary residence and pension) are below this threshold, you pay no Box 3 tax.
...
- Savings (banktegoeden): ~1.03% fictitious return
- Investments: ~6.04% fictitious return
- Real estate: ~6.04% fictitious return

The fictitious return is taxed at **36%** (Box 3 rate in 2026).

**Example**: If you have €70,000 in savings (€13,000 above the €57,000 threshold):
- Taxable savings: €13,000
- Fictitious return: €13,000 × 1.03% = €134
- Tax: €134 × 36% = approximately €48

For most expats building an emergency fund, the tax impact is modest — you are unlikely to hold more than €57,000 in accessible savings. If you do, the effective tax rate on savings is still relatively low compared to many countries.

### The Box 3 Controversy

Dutch Box 3 taxation has been legally contested. The Supreme Court (Hoge Raad) ruled in 2021 that the old fictitious return system violated human rights when actual returns were lower. The Dutch government has been reforming the system since then. The new system (effective from 2027 under current plans) will tax actual returns rather than fictitious ones. Check the Belastingdienst for the latest position — this is an active area of legislative change.
...
Once your emergency fund is established, additional savings can be placed in slightly higher-returning products (term deposits via Raisin, index funds via DeGiro or Saxo, or pension savings via a lijfrente). The emergency fund itself should remain liquid and stable.
...
| Product | Rate (indicative 2026) | Accessibility | Deposit protection | Best for |
|---|---|---|---|---|
| Dutch bank savings (ING/ABN/Rabo) | 1.4-2.0% | 1 day | €100,000 DGS | Core emergency fund |
| bunq Easy Savings | 1.0-2.0% | Instant | €100,000 DGS | Core fund + expat features |
| Raisin instant access | 1.5-3.0% | 1-3 days | Up to €100,000 (country DGS) | Secondary savings |
| Raisin fixed-term | 2.5-3.5% | Locked | Up to €100,000 (country DGS) | Tier 2 savings |
| Wise Assets (EUR) | Variable | 1-2 days | Not DGS protected | Currency holding only |

---

## Useful Resources

- [Belastingdienst: Box 3 savings](https://www.belastingdienst.nl/wps/wcm/connect/bldcontentnl/belastingdienst/prive/vermogen_en_aanmerkelijk_belang/vermogen/)
