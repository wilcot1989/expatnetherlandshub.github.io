...
category: "finance"
categories: ["finance"]
tags: ["ZZP", "freelancer", "tax", "BTW", "IB aangifte", "zelfstandigenaftrek"]
keywords: ["zzp tax netherlands", "freelancer tax netherlands 2026", "dutch freelance tax guide", "btw zzp expat"]
affiliate: true
schema_type: "Article"
toc: true
faq:
  ...
  - q: "What is the zelfstandigenaftrek and how much is it in 2026?"
    a: "The zelfstandigenaftrek is a tax deduction available to self-employed people who meet the 'urencriterium' — you must spend at least 1,225 hours per year on your business. In 2026 the deduction is €5,030. It reduces your taxable profit, which means you pay income tax on a smaller amount. Note that the deduction is being phased down each year towards €900 by 2027, so the current amount is one of the last chances to benefit significantly."
  ...
  - q: "What is a voorlopige aanslag and do I need one as a freelancer?"
    a: "A voorlopige aanslag is a provisional tax assessment. Because freelancers do not have an employer withholding income tax for them, the Belastingdienst uses this mechanism to collect income tax in advance — usually in monthly instalments throughout the year. You can request or adjust a voorlopige aanslag yourself via Mijn Belastingdienst. Getting this right prevents a large, unexpected bill in the spring after filing your annual return."
  - q: "What business expenses can I deduct as a ZZP freelancer in the Netherlands?"
    a: "You can deduct any costs that are genuinely and exclusively for your business — these are called zakelijke kosten. Common deductible expenses include: professional equipment (laptop, camera, tools), software subscriptions, home office costs (a proportion of rent or mortgage interest if you have a dedicated workspace), travel costs for business, professional development and courses, accountant and bookkeeper fees, telephone and internet (business portion), business bank account fees, insurance, and marketing costs. Personal expenses — even ones connected loosely to work — are not deductible."
---

The first time I sat down to work out my taxes as a self-employed person in the Netherlands, I had four browser tabs open, two printouts from the Belastingdienst website, and a strong cup of coffee that went cold before I got anywhere. I had filed UK self-assessment returns before, and I thought I broadly understood what was coming. I did not.
...
If you have just registered your business, you may also want to read my guides on [registering as a ZZP freelancer in the Netherlands](/guides/work/freelancer-zzp-guide-netherlands-2026/) and [how to register at the KvK as an expat](/guides/work/kvk-registration-expat-guide-2026/) before diving in here.
...
1. **BTW (belasting toegevoegde waarde)** — Dutch VAT, which you charge on most of your invoices and remit to the Belastingdienst quarterly
2. **IB (inkomstenbelasting)** — Income tax on your profit, filed annually
...
It looks like a lot, but any decent invoicing software handles this automatically. I use a simple accounting package and have a template that fills in most of these fields before I send a word.
...
You file via **Mijn Belastingdienst Zakelijk** (the business portal at belastingdienst.nl). You will need your DigiD or eHerkenning to log in. For the first time, this can take a while to set up — see my [DigiD guide for expats](/guides/legal/digid-guide-expats-2026/) if you have not done this yet.
...
For a full explanation of how Box 1, Box 2, and Box 3 work, see my [guide to the Dutch tax system for expats](/guides/finance/dutch-tax-system-expats-guide-2026/). Here I focus specifically on the rules and deductions that apply to freelancers.
...
1. **Zelfstandigenaftrek** — deducted from profit if you meet the urencriterium
2. **Startersaftrek** — an additional deduction in your first three years
3. **MKB-winstvrijstelling** — 14% of the remaining profit is exempt from tax
...
|----------------|---------------------|
| Up to approximately €76,817 | approximately 36.97% |
| Above approximately €76,817 | approximately 49.50% |
...
The **zelfstandigenaftrek** is a fixed deduction of **€5,030 in 2026**. It is deducted directly from your profit before tax.
...
At a marginal tax rate of approximately 37%, a €5,030 deduction saves you roughly **€1,861 in income tax** — not insignificant.

**Important change for 2026 and beyond:** The zelfstandigenaftrek is being cut further each year. By 2027 it will drop to €900. The government's rationale is to reduce the tax advantage of self-employment relative to employment, pushing freelancers to make their own pension arrangements instead. If you are planning your finances over multiple years, model your tax liability without the current deduction level — it will not stay at €5,030 for long.

### Startersaftrek: The Starter Bonus

If you are in your first years of business, the **startersaftrek** gives you an additional **€2,123 per year** on top of the zelfstandigenaftrek. Combined, that is **€7,153 in total deductions** in your starter years.
...
### MKB-Winstvrijstelling: The 14% Profit Exemption

The **MKB-winstvrijstelling** (small and medium-sized business profit exemption) is available to all self-employed people, regardless of whether they meet the urencriterium. It exempts **14% of your profit** from income tax — but calculated after the zelfstandigenaftrek and startersaftrek have been applied.
...
**Business bank account fees:** Keep your business and personal accounts separate and the fees are deductible. This is one reason I recommend every ZZP freelancer opens a dedicated business account.
...
For a step-by-step walkthrough of how to file your Dutch tax return, see my [how to file guide](/guides/finance/dutch-tax-return-how-to-file-2026/) and the [expat-specific tax return guide](/guides/finance/expat-tax-return-netherlands-2026/).
...
2. Your business expenses (zakelijke kosten)
3. Your gross profit
4. Zelfstandigenaftrek (if eligible)
5. Startersaftrek (if applicable)
6. MKB-winstvrijstelling (14% of remaining profit)
7. Final taxable profit
...
| **Gross profit** | | **€51,500** |
| Less: zelfstandigenaftrek | Fixed 2026 deduction | −€5,030 |
| Less: startersaftrek | Applicable in years 1–3 | −€2,123 |
| Profit after aftrek | | €44,347 |
| Less: MKB-winstvrijstelling (14%) | 14% × €44,347 | −€6,209 |
| **Taxable Box 1 income** | | **€38,138** |
| Income tax (approx. 36.97%) | 36.97% × €38,138 | **approximately €14,099** |

So on €60,000 revenue, after expenses and all applicable deductions, your income tax bill is approximately **€14,099** — an effective rate of about 23.5% on your gross revenue, or 27.4% on your gross profit.

Without the zelfstandigenaftrek and startersaftrek, the taxable income before MKB-winstvrijstelling would be €51,500, rising the tax bill by roughly €2,500. Use these deductions while they are available.
...
I strongly recommend using accounting software (boekhoudprogramma) from day one. Good options for ZZP freelancers in the Netherlands include:
...
You cannot file any Dutch tax return without a DigiD and a BSN. If you are still sorting these out, the [DigiD guide for expats](/guides/legal/digid-guide-expats-2026/) walks you through the process step by step.
...
The [30% ruling](/guides/finance/30-percent-ruling-netherlands-2026/) is available to expats who were recruited from abroad and meet certain salary and expertise conditions — but it applies to **employment income**, not freelance profit. As a ZZP freelancer running your own eenmanszaak, you cannot claim the 30% ruling in the standard sense.

If you previously had the 30% ruling as an employee and then went freelance, your ruling ends at the point you leave employment. Use the [30% ruling calculator](/tools/30-percent-ruling-calculator/) to model what your tax looks like after the transition to self-employment, so you are not caught off guard in your first freelance tax year.
...
If you want to estimate your net income at different revenue levels — including what happens if you cross the higher tax bracket — the [salary checker tool](/tools/salary-checker/) on this site gives a quick indication. It is designed for employment income but gives a useful ballpark for freelancers to work from.

---

## Summary: Your Freelancer Tax Checklist for 2026

Here is the practical checklist I give to expat clients who have just registered as ZZP:
...
Dutch freelance tax is manageable — I promise. The first year is the steepest part of the learning curve. By year two, the quarterly BTW return takes me about forty-five minutes, my bookkeeping software does most of the work, and my accountant reviews my annual return in a single session.
...
One final note: the Dutch tax system is changing. The zelfstandigenaftrek will be €900 by 2027. The political debate about ZZP taxation — and whether freelancers should be required to have pension and disability insurance — is ongoing. Keep an eye on announcements from the Belastingdienst each autumn, when the following year's rates and thresholds are confirmed.

For more on the broader Dutch tax system for expats, including Box 2 and Box 3 implications, see the [Dutch tax system guide](/guides/finance/dutch-tax-system-expats-guide-2026/). And if you want a full walkthrough of filing your annual return, the [Dutch tax return step-by-step guide](/guides/finance/dutch-tax-return-how-to-file-2026/) has everything you need.
