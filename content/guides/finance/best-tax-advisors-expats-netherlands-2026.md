...
My guide on [filing your Dutch tax return yourself](/guides/finance/dutch-tax-return-how-to-file-2026/) covers the DIY process step by step if that is where you land.
...
- You are applying for, extending, or optimising your [30% ruling](/guides/finance/30-percent-ruling-netherlands-2026/)
- You are self-employed or have freelance income in addition to employment
- You are a US citizen (FBAR and FATCA obligations make Dutch tax returns substantially more involved — see my [guide for American expats](/guides/finance/netherlands-for-american-expats-2026/))
...
If you are a freelancer in the Netherlands, my [ZZP guide](/guides/work/freelancer-zzp-guide-netherlands-2026/) has more on the bookkeeping side of self-employment, and my [tax guide for freelancers](/guides/finance/tax-freelancers-zzp-netherlands-2026/) covers the tax return specifically.
...
If you have the 30% ruling, this should be a non-negotiable. The 30% ruling interacts with your personal tax return in ways that are not always obvious, and errors can cost you money or create problems with the Belastingdienst. I cover the ruling in detail in my [30% ruling guide](/guides/finance/30-percent-ruling-netherlands-2026/) — but handling it correctly on your return is a separate skill.

The [30% ruling eligibility guide](/guides/finance/30-percent-ruling-eligibility-guide-2026/) is also worth reading before you speak to any advisor, so you come to the conversation informed.
...
These are ballpark figures based on what expats I work with have reported paying in recent years. Some firms offer subscription or bundle pricing if you use them year after year.
...
For context, the [Dutch tax return checklist for expats](/guides/finance/dutch-tax-return-checklist-expats-2026/) includes the documents you will need to gather regardless of whether you file yourself or use a professional.

---

## Well-Known Expat Tax Firms in the Netherlands

There are several firms that specifically target the expat market and have built a track record in this space. I am not in a position to endorse any of them — I do not have a financial relationship with any tax firm, and the right choice depends on your specific situation, location, and preferences. What I can do is describe what each is known for so you can request quotes and make an informed comparison.
...
Not all Dutch expat tax firms handle US filings. Some partner with US-based firms; others have in-house CPAs. Confirm explicitly what US services are included in any quote. My [guide for American expats in the Netherlands](/guides/finance/netherlands-for-american-expats-2026/) covers this in more detail.
...
I do not want to create the impression that professional help is always necessary. The [Dutch tax system guide for expats](/guides/finance/dutch-tax-system-expats-guide-2026/) explains how the return works, and [filing your expat tax return](/guides/finance/expat-tax-return-netherlands-2026/) walks through the process practically. Many employed expats do this themselves without difficulty.
...
The peace-of-mind argument is real. I have spoken with expats who spent 12+ hours on their own return, made an error, received a correction letter, and then spent another five hours dealing with the aftermath. At an hourly value of your own time, a EUR 350 professional fee can make perfect sense.
...
6. **Can you handle correspondence with the Belastingdienst if they send a follow-up question?** (And is this included in the fee or billed separately?)
7. **If I have questions during the year — not at return time — can I contact you and at what cost?**
8. **Do you handle US tax filings?** (Only relevant for American expats)
9. **What professional membership do you hold?** (Look for NOB or RB)
10. **What information do you need from me, and in what format?**
