---
title: "Dutch Pay Slips Explained: How to Read Your Loonstrook in 2026"
...
I was not alone in that confusion. Almost every expat I work with has the same experience. You negotiate a salary, you feel good about it, and then the first payment arrives and you start wondering whether something has gone wrong.
...
If you have not yet accepted a job offer, the [salary negotiation guide for expats](/guides/work/salary-negotiation-netherlands-expats-2026/) covers how to benchmark and negotiate your gross salary. And if you want the broader picture of how Dutch income tax works beyond what appears on your pay slip, the [Dutch tax system guide for expats](/guides/finance/dutch-tax-system-expats-guide-2026/) is the natural companion to this article.
...
Keep your loonstrooks. You will need them when filing your income tax return (aangifte inkomstenbelasting), when applying for a mortgage or rental property, for visa renewals, and occasionally for benefit applications. I keep mine as PDFs organised by year — it takes five minutes per year and has saved me several hours of scrambling on multiple occasions.
...
1. **Header information** — your name, BSN (citizen service number), employer details, pay period, and department/cost centre
2. **Earnings (inkomsten/loon)** — your gross pay and any additions
3. **Deductions (inhoudingen)** — tax, social contributions, and other withholdings
4. **Employer contributions** — what your employer pays on top of your salary (not always shown, but sometimes included for transparency)
5. **Net pay (netto loon)** — what actually lands in your account
6. **Cumulative year-to-date figures** — running totals since January
...
This is one of the most important lines for expats on the [30% ruling](/guides/finance/30-percent-ruling-netherlands-2026/). The reduction in fiscaal loon is the mechanism that delivers the tax benefit. Use the [30% ruling calculator](/tools/30-percent-ruling-calculator/) to see the difference this makes to your take-home pay before accepting a role.
...
Let me walk through what a typical pay slip looks like for someone earning €4,500 gross per month in 2026. I am using a single person, over 30, no 30% ruling, on a permanent contract with a pension scheme. Numbers are illustrative but realistic.
...
Run your own numbers with the [salary checker tool](/tools/salary-checker/) to get a personalised breakdown based on your actual gross, contract type, and ruling status.
...
When comparing Dutch salary offers with offers from other countries, it is worth checking whether a 13th month is included in the quoted annual figure. I have seen more than a few expats accept roles where the Dutch employer listed their 12-month package next to a competitor offering 13 months — a meaningful difference.
...
Even when everything seems routine, I recommend checking your pay slip each month against a short mental checklist:
...
Many expats receive a refund after filing. Common reasons include: not having worked the full year, having paid into a Netherlands-based pension, or having significant deductible costs. The [Dutch tax system guide](/guides/finance/dutch-tax-system-expats-guide-2026/) covers the annual return process in detail.

For cost of living context and to understand how your net salary translates into actual spending power, try the [cost of living calculator](/tools/cost-of-living-calculator/) — it lets you input your net income and see how different Dutch cities compare.
...
Your pay slip should always match the salary and allowances specified in your [employment contract](/guides/work/dutch-employment-contract-explained-2026/). If you notice systematic discrepancies — a consistently lower bruto loon, missing allowances, or a higher ZVW deduction than expected — review your contract first, then escalate to HR.
...
If you are still in the offer stage and want to understand what a particular gross salary actually means for your day-to-day finances, start with the [salary checker](/tools/salary-checker/) and the [salary negotiation guide](/guides/work/salary-negotiation-netherlands-expats-2026/). And if the 30% ruling might apply to you, the [30% ruling guide](/guides/finance/30-percent-ruling-netherlands-2026/) explains the eligibility criteria and the application process in full.
