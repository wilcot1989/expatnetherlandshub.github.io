...
Six months later, she came to me frustrated. A colleague who had joined the same company at the same level, with similar experience, was earning EUR 15,000 more per year. Not because he was better. Not because he had more bargaining power. Because he had spent forty minutes doing salary research and asked for what he was worth.

Marta had no idea what product managers earned in the Netherlands. She had no idea that her package was missing a 13th month bonus that half the market pays. She did not know that she qualified for the [30% ruling](/guides/finance/30-percent-ruling-netherlands-2026/), which would have significantly increased her net pay and made her negotiating position even stronger. She had said yes to the first number because it felt like more than she was earning in Warsaw, and she assumed the Dutch market worked the same way she was used to.
...
- Up to EUR 38,441: 35.82%
- EUR 38,441 and above: 49.50%

Yes, you read that correctly. Everything above EUR 38,441 gross per year is taxed at 49.5%. This is the box 1 rate and it is not a typo. The Netherlands is not a low-tax country.
...
Let's take a gross salary of EUR 70,000 per year (EUR 5,833 per month gross):

- Tax on first EUR 38,441: approximately EUR 13,777
- Tax on remaining EUR 31,559: approximately EUR 15,622
- Total income tax: approximately EUR 29,399

Add the ZVW healthcare contribution (approximately 5.32% on income up to EUR 71,628 in 2026, currently borne partly by employer through a separate levy), and various other deductions, and your net annual income lands at roughly EUR 40,500 to EUR 42,000 — meaning you take home about 57-60% of your gross.

At EUR 70,000 gross per year, that works out to roughly EUR 3,375 to EUR 3,500 net per month.

### Vakantiegeld: The 8% You Cannot Forget

Every Dutch employment contract includes vakantiegeld — a mandatory 8% holiday allowance on your gross annual salary. This is the law (Burgerlijk Wetboek), not a company perk.

On EUR 70,000 gross per year, your vakantiegeld is EUR 5,600 gross (paid out in May or June as a lump sum). After tax, this is roughly EUR 2,800 to EUR 3,200 net in one payment.
...
The [30% ruling](/guides/finance/30-percent-ruling-netherlands-2026/) allows qualifying expats to receive 30% of their gross salary entirely tax-free. To qualify in 2026, you must:
...
Use the [30% ruling calculator](/tools/30-percent-ruling-calculator/) to run your own numbers before any negotiation conversation.
...
Ask the employer what percentage of the total pension premium they cover. This is real money — a difference of 10% in employer contribution can add EUR 1,500 to EUR 3,000 per year to your effective compensation. Read more about how Dutch pensions work for expats in my [Dutch pension system guide](/guides/finance/dutch-pension-system-expats-2026/).
...
I have watched expats handle Dutch salary negotiations beautifully and I have watched them crash and burn. The crashes almost always happen because someone applied the negotiation norms of their home country to a Dutch context.

### Be Direct — But Not Aggressive

Dutch people negotiate by stating what they want, calmly, with a reason. "I've researched the market and I believe EUR 78,000 better reflects my experience for this role" lands well. Circling around the number, hinting, hoping the employer will volunteer a higher figure, does not. The Dutch find indirectness exhausting.
...
Nothing impresses a Dutch HR manager more than arriving with data. "According to the Intermediair Salary Guide and Glassdoor data for this role type in Amsterdam, the market range is EUR 70,000 to EUR 85,000. Given my five years of experience and specialisation in X, I'd like to target the upper half of that range." This framing works because it is direct, evidenced, and logical.

This connects to the broader [Dutch work culture](/guides/work/dutch-work-culture-guide-expats-2026/) value of *nuchterheid* — a kind of grounded practicality. Show your working. Make a rational case. Leave emotion out of it.
...
Here is the process I walk my clients through, in order.
...
Check whether a CAO applies before your interview — ideally before you apply. You can read more about how Dutch employment contracts work in my [Dutch employment contract guide](/guides/work/dutch-employment-contract-explained-2026/).
...
In an initial screening call, if the recruiter asks for your salary expectations early on, it is reasonable to ask: "What is the budgeted range for this role?" Many Dutch recruiters will tell you directly. If they will not, give a range based on your research, anchored at the top: "Based on the market and my experience, I'd expect somewhere in the EUR 75,000 to EUR 85,000 range — is that aligned with what you have in mind?"
...
1. Express genuine interest in the role first ("I'm very interested in this position and the team")
2. Name the issue specifically ("The salary is below what I'd hoped for based on my research")
3. Give your counter with evidence ("Given the market range for this role in Amsterdam and my specific experience in X and Y, I'd like to propose EUR 78,000")
4. Leave room for polderen ("I'm keen to find something that works for both of us")
...
These are all normal and reasonable questions in a Dutch negotiation context. Read more about [job interview tips for the Netherlands](/guides/work/job-interview-tips-netherlands-2026/) if you want to think about the full interview and offer process together.
...
**At initial screening, if asked about salary expectations:**
> "Based on my research of the market for this role in [city], I'd be targeting somewhere between EUR [X] and EUR [Y]. Is that aligned with your budget for the position?"

**When you receive an offer below your target:**
> "Thank you for the offer — I'm genuinely interested in the role and the team. I'd like to discuss the salary. Based on the market data I've looked at and my experience in [specific area], I was hoping we could get to EUR [number]. Is there any flexibility there?"
...
**When you have a competing offer and want to mention it honestly:**
> "I should mention that I do have another offer on the table, at EUR [X]. I'd prefer to join [company] based on [specific reason], and I wanted to be transparent rather than leave that information out."

**When negotiating a 30% ruling-adjusted comparison:**
> "I've been modelling the net figures with the 30% ruling applied. With that factored in, the EUR [X] offer becomes very competitive on a net basis — but I'd still want to get the gross to EUR [Y] to ensure it's sustainable once the ruling ends after five years."
...
You can also use the [salary checker tool](/tools/salary-checker/) to benchmark your position, and the [cost of living calculator](/tools/cost-of-living-calculator/) to understand what a given net salary actually buys you in different Dutch cities. The [cost of living guide for the Netherlands](/guides/housing/cost-of-living-netherlands-2026/) covers this in detail.

If you are weighing a freelance or ZZP arrangement against an employed role — a common consideration for expats with specialist skills — the economics look very different. My [freelancer and ZZP guide for the Netherlands](/guides/work/freelancer-zzp-guide-netherlands-2026/) walks through the comparison.
...
*Sarah van den Berg is an expat coach and relocation specialist based in Amsterdam. She has helped hundreds of expats find their footing in the Dutch job market since 2015. For more on working in the Netherlands, see the [Dutch work culture guide](/guides/work/dutch-work-culture-guide-expats-2026/) and the [Dutch employment contract explainer](/guides/work/dutch-employment-contract-explained-2026/).*
