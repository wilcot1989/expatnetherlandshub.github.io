...
categories: ["finance"]
tags: ["tax", "belastingdienst", "expats", "netherlands", "2027", "form-m", "30-percent-ruling"]
keywords: ["Netherlands tax deadline 2027", "expat tax filing 2027", "Form M Belastingdienst", "Dutch tax checklist expat"]
featured_image: "/images/categories/finance.svg"
affiliate: true
draft: false
schema_type: "Article"
faq:
  - question: "When is the Dutch tax deadline for 2027?"
    answer: "The standard deadline for filing your 2026 income tax return is 1 May 2027. You can request an extension until 1 September 2027, and tax advisers registered with the Belastingdienst can get extensions running into 2028."
  ...
  - question: "Can I file my Dutch taxes in English?"
    answer: "The Belastingdienst portal is mostly Dutch, but the English-language information pages are useful. Most expats either use a bilingual tax adviser like Blue Umbrella or ExpataX, or use English-language tax software. The actual return is submitted in Dutch format regardless of which language you used to prepare it."
---

The week I finally understood Dutch taxes, I was sitting on the floor of my Utrecht apartment surrounded by payslips, a printout of my 30% ruling decision, three different versions of a jaaropgaaf, and a half-empty bottle of supermarket Rioja. It was April 2018, my first full year in the Netherlands, and I had just realised — at 23:40 on a Sunday — that the form I was trying to file was not the form I was supposed to file. I had been wrestling with the standard income tax return for an hour when a friend texted me back: "You're a migrant. You need the M-formulier." I had no idea what that was. I am, apparently, not unique in this.
...
The Dutch tax year matches the calendar year. So everything you earned, paid, owned, and lost between **1 January 2026 and 31 December 2026** is what goes into your 2027 filing. Here is the timeline I keep stuck to the inside of my filing cabinet:
...
I'll be honest: in my first three years I filed in late April every time, and every time I regretted not starting in March. If you have a refund coming, every week you delay is a week the Belastingdienst sits on your money interest-free.
...
1. **Two periods in one form.** It splits 2026 into your "before/after arrival" (or "before/after departure") period and asks for worldwide income only for the portion you were a Dutch resident, and Dutch-source income for the other portion.
2. **Worldwide income disclosure.** Even for the non-resident period, you may need to declare worldwide income for *Belastingvermindering* (tax credit) calculations. The Belastingdienst uses this to determine which Dutch tax credits you qualify for on a pro-rata basis.
3. **No clean online flow.** Until recently you had to request a paper version. Many tax advisers now file Form M digitally through their professional software (the *Becon-software*), but the consumer portal still has gaps.
4. **Treaty mechanics.** If your country of departure has a double-taxation treaty with the Netherlands (the US, UK, Germany, France, India, and most of the EU do), Form M is where you apply treaty relief.

I see expats every January asking on Reddit and in Facebook groups whether they "really" need Form M for their arrival year. The answer is yes, unless you arrived on 1 January or left on 31 December, in which case the standard form is correct. Everyone else, every other arrival or departure date — Form M.

If your Dutch is limited and your arrival year involved foreign income, a relocation allowance, a sign-on bonus paid before arrival, or you sold property abroad before moving, please get help. This is exactly the scenario where a couple of hundred euros to [an English-speaking accountant](/blog/best-english-speaking-accountant-netherlands-2026/) saves you four figures in mistakes.
...
The places I see expats go wrong:
...
If you're a freelancer or zzp'er, Box 1 gets considerably more involved. I have a separate walkthrough on [freelance expat tax filing](/blog/tax-filing-freelance-expat-netherlands-2026/) that covers *zelfstandigenaftrek*, *startersaftrek*, and the *MKB-winstvrijstelling*, plus VAT reconciliation. And if you haven't yet registered, my [ZZP registration step-by-step](/blog/zzp-registration-netherlands-step-by-step-2026/) is the starting point.

For pure employees with no side income, my [employee tax return walkthrough](/blog/tax-return-netherlands-employee-expats-2026/) covers the standard path in detail.
...
Every January I get the same email from readers: "Can I do this myself?" The honest answer is: it depends on your fact pattern. Here's the tree I walk through in my head.
...
In the middle there is a grey zone: expats with the 30% ruling, straightforward employment, and modest investments. Here you can DIY, but the value of a one-time consultation (€150–€250) is high because the choices you make in your first year of filing tend to ripple through future returns. I'd rather pay a one-time fee than discover three years later that I checked the wrong box and now owe back taxes plus interest.

For finding the right adviser, I keep an updated list in my [English-speaking accountant guide](/blog/best-english-speaking-accountant-netherlands-2026/) and a more 30%-ruling-focused round-up in [best tax advisor for 30% ruling](/blog/best-tax-advisor-30-percent-ruling-2026/).

## Blue Umbrella vs ExpataX: how I'd choose between them
...
**Blue Umbrella** has been around since the early 2000s and feels like the old-school choice — they have a physical office in Amsterdam, you can book a phone or in-person consultation, and they're particularly strong on complex cases (US citizens, founders, substantial Box 3 portfolios). Their pricing sits in the mid-to-upper range, but you're paying for genuine specialist time. If your situation has any of the "almost certainly need an adviser" red flags above, I'd start here.

[Check Blue Umbrella's expat tax services](https://go.expatnetherlandshub.com/blue-umbrella?ref=/blog/netherlands-tax-deadline-2027-expat-checklist/){:target="_blank" rel="nofollow sponsored noopener"}
...
[Compare ExpataX packages](https://go.expatnetherlandshub.com/expatax?ref=/blog/netherlands-tax-deadline-2027-expat-checklist/){:target="_blank" rel="nofollow sponsored noopener"}
...
Before you start your filing — whether DIY or for handing to an adviser — gather these. I keep a manila folder labelled "TAX 2026" from January onwards and drop each one in as it arrives.
...
If you used the [Belastingdienst's English-language portal](https://www.belastingdienst.nl/wps/wcm/connect/en/individuals), bookmark it — the English pages cover the high-level concepts and link out to the Dutch forms where the actual work happens.

## Common mistakes I see every single year

After years of reading expat tax horror stories, the same handful of mistakes come up over and over:

1. **Filing the standard form when Form M was required.** The Belastingdienst usually catches this and sends you back to file the M, but it delays your assessment by months.
2. **Forgetting foreign bank balances on 1 January / 31 December.** Box 3 is based on year-end positions. If you didn't snapshot your foreign accounts on 31 December 2026, do it retroactively — most banks let you download a year-end statement.
3. **Double-deducting the 30% allowance.** Your employer already removed it from your taxable salary. Do not deduct it again.
4. **Not declaring crypto.** Crypto is a Box 3 asset. Year-end value matters, not transaction history.
5. **Missing the fiscal partner box.** If you live with a spouse or registered partner (or in some cases a long-term cohabitant), you can choose to be fiscal partners. This lets you shift deductions and Box 3 allowances between you. It's almost always worth running the numbers both ways.
6. **Assuming "no letter from Belastingdienst" means "no need to file."** If you owe tax, you must file regardless of whether you received an invitation. If you're due a refund, you have up to five years to file and claim it.
7. **Filing too late and getting fined.** The first late-filing fine is around €385 for income tax. Repeated lateness escalates fast. If 1 May is approaching and you're not ready, request the extension. It's free, it's instant, and it buys you four months.
8. **Ignoring the *voorlopige aanslag*.** If you receive a provisional assessment in 2027 that looks wrong, react. Don't just pay it and wait for the final assessment — the provisional figure is what gets collected first.
9. **Throwing away the WOZ letter.** The municipality sends WOZ valuations in early 2027 for tax year 2026 purposes. You need this number for your filing if you own a home.
10. **Forgetting that emigration triggers a final filing.** If you're leaving the Netherlands in 2026 or 2027, your final-year filing is also a Form M and includes some exit-tax mechanics for Box 2 and pensions.

## My actual workflow for filing in 2027

For the curious, here's the order I'll work through my own 2027 filing in (and what I'd recommend for most expats with moderately complex situations):

1. **Mid-January 2027**: open the "TAX 2026" folder, list every document I'm waiting for.
2. **End of January 2027**: download year-end statements from every bank and broker, foreign and Dutch.
3. **Early February 2027**: chase any missing *jaaropgaaf*. Employers are legally obliged to provide it.
4. **Late February 2027**: decide DIY or adviser. If adviser, contact them now — by March they're booked solid.
5. **Early March 2027**: open the portal, pre-fill the return, and read through what the Belastingdienst already knows about me.
6. **Mid-March 2027**: complete a draft. Do not submit yet.
7. **End of March 2027**: review every Box 3 line, especially the *tegenbewijsregeling* if my actual returns lagged the deemed return.
8. **Early April 2027**: submit. Aim for refund payout in July.
9. **April through July 2027**: keep checking the portal for the *voorlopige aanslag* and respond promptly to any questions.
...
And if you remember nothing else: the M is for migration. Eight years on, I still flinch when I see those two letters on an envelope.
