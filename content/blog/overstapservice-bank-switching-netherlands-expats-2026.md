...
categories: ["finance"]
tags: ["overstapservice", "switch bank", "banking Netherlands", "IBAN", "direct debit", "expats", "netherlands", "wise"]
keywords: ["Overstapservice English explained", "switch bank account Netherlands expat", "change Dutch bank IBAN direct debits", "how to switch banks Netherlands 2026"]
featured_image: "/images/categories/finance.svg"
affiliate: true
draft: false
schema_type: "Article"
faq:
  - q: "What is the Overstapservice?"
    a: "It is the joint Switching Service of Dutch banks, coordinated through the Dutch Payments Association (Betaalvereniging Nederland). For 13 months after your chosen start date it forwards incoming payments to your old current account on to your new one, routes your existing direct debits from the new account, and tells Dutch payers and collectors your new IBAN when they try to use the old one."
  - q: "How much does the Overstapservice cost?"
    a: "Nothing. It is free for both consumers and business account holders. You apply through your new bank, usually at the moment you open the account."
  - q: "Which banks participate?"
    a: "Participants include ABN AMRO, ING, Rabobank, bunq, Knab, ASN Bank, Triodos Bank, Revolut (consumers only), Van Lanschot Kempen, BNG Bank, BNP Paribas, Deutsche Bank and Handelsbanken. Both your old and your new bank must be participants. Some banks only forward payments without full participation, and non-Dutch providers such as Wise and N26 are not on the participant list — check the official overview before you rely on it."
  - q: "Does the Overstapservice close my old account?"
    a: "Not automatically. You can indicate on the application that you want the old account closed, but by default it stays open during the 13-month period. Many people keep it open deliberately for the first few months so nothing is lost, then close it once no traffic remains."
  - q: "What does the Overstapservice not do?"
    a: "It does not move standing orders and scheduled transfers that you set up yourself, it does not migrate other products such as savings accounts, credit cards or investment accounts, and it does not force payers to update your IBAN — some ignore the notification. It also cannot fix mandates you hold with foreign companies, which the Dutch service has no reach over."
  - q: "How long does switching take from start to finish?"
    a: "Plan on three to six weeks. You need a new account first, the service requires a minimum of about two weeks between application and start date, and you choose a start date between two weeks and three months out. The forwarding then runs for 13 months, which is deliberately more than a year so that annual payments get caught."
  - q: "Should I switch banks at all as an expat?"
    a: "Only for a concrete reason: English-language service, lower monthly fees, a mortgage relationship with the same bank, better app quality, or a move from a fintech to a Dutch-licensed bank with a real NL IBAN. Switching purely to chase a small fee difference rarely repays the administrative effort."
products:
  - name: "Wise"
    url: "https://go.expatnetherlandshub.com/wise?ref=/blog/overstapservice-bank-switching-netherlands-expats-2026/"
    price: "0.00"
...
*Disclosure: this article contains affiliate links. If you sign up through them we may earn a commission at no extra cost to you. It never changes your cost and it does not decide what we recommend.*

> **Quick answer:** Open the new Dutch account first, then apply for the free Overstapservice at that new bank and pick a start date at least two weeks out. For 13 months it forwards incoming payments from your old account, runs your existing direct debits from the new one, and notifies Dutch payers of your new IBAN. You still have to move your own standing orders, tell your employer, migrate savings and cards, and eventually close the old account yourself. Keep international transfers separate from all of this — a low-cost provider such as <a href="https://go.expatnetherlandshub.com/wise?ref=/blog/overstapservice-bank-switching-netherlands-expats-2026/" target="_blank" rel="nofollow sponsored noopener">Wise</a> handles cross-border payments far more cheaply than any Dutch bank's SWIFT desk.
...
Why 13 months and not 12? Because virtually every recurring payment occurs at least once a year, so a thirteen-month window catches the annual ones — insurance renewals, subscriptions, municipal levies — with a month to spare. If you find something still trailing at the end, the service can be used again for another 13 months.
...
**Both banks must participate.** If either your old or new provider is not a participant, the service does not run. This is the single biggest practical constraint for expats, because so many of us arrive on a fintech account.
...
Notably absent from the participant list are Wise and N26. Both are widely used by expats, and both give you an account you can be paid into, but if your "old account" is with one of them there is no Switching Service to lean on: you migrate everything manually. Because participation and brand names change, check the [current overview at overstapservice.nl](https://www.overstapservice.nl/deelnemende-banken/) before you plan around it.

If you are still deciding which Dutch bank to move to, our [comparison of the best accounts for expats](/guides/finance/best-bank-account-expats-netherlands-2026/) and the head-to-head on [ING versus Rabobank](/blog/ing-vs-rabobank-expats-2026/) cover fees, English service and app quality. If you have not opened your first Dutch account yet, start with the [step-by-step guide](/blog/getting-a-dutch-bank-account-step-by-step-2026/) instead — you do not need the Switching Service for a first account.
...
- [Getting a Dutch bank account step by step](/blog/getting-a-dutch-bank-account-step-by-step-2026/)
- [ING vs Rabobank for expats 2026](/blog/ing-vs-rabobank-expats-2026/)
- [Best international money transfer options from the Netherlands](/guides/finance/best-international-money-transfer-netherlands-2026/)
- [Dutch business bank account for ZZP](/guides/finance/dutch-business-bank-account-zzp-2026/)

**External sources:** [Overstapservice — participating banks](https://www.overstapservice.nl/deelnemende-banken/) and the [Dutch Payments Association on the Switching Service](https://www.betaalvereniging.nl/en/knowledge-base/special-accounts-and-services/switching-service/).
