...
categories: ["finance"]
tags: ["deposit-guarantee", "depositogarantiestelsel", "dnb", "banking-safety", "savings", "netherlands", "expats"]
keywords: ["Dutch deposit guarantee scheme", "depositogarantiestelsel expats", "is my money safe Dutch bank", "100000 deposit guarantee Netherlands", "DNB deposit guarantee", "which banks covered deposit guarantee Netherlands"]
featured_image: "/images/categories/finance.svg"
affiliate: true
draft: false
schema_type: "Article"
faq:
  - q: "How much of my money is protected in a Dutch bank?"
    a: "Up to €100,000 per person, per bank, under the Dutch deposit guarantee scheme administered by De Nederlandsche Bank. The limit applies to your total eligible deposits at that bank, not per account — so three accounts at the same bank share one €100,000 ceiling. There is no minimum: protection starts from one cent."
  ...
  - q: "Are Revolut, N26 and similar accounts covered by the Dutch scheme?"
    a: "Generally no — they are covered by the scheme of the country that issued their banking licence. Revolut's European banking entity is licensed in Lithuania, so eligible deposits there fall under the Lithuanian scheme, also up to €100,000. N26 is licensed in Germany and falls under the German scheme. The protection level is harmonised across the EU, but the administering authority, the language of the process and the payout mechanics differ."
  - q: "Is money held with a payment provider like Wise protected the same way?"
    a: "No, and this is an important distinction. Electronic money institutions are not banks and their customer balances are not covered by a deposit guarantee scheme. Instead they are required to safeguard client funds — holding them separately from company money, typically at regulated banks or in low-risk assets, so that client money is not available to company creditors. That is meaningful protection but it is a different legal mechanism, with no €100,000 government-backed guarantee attached. Treat such accounts as transaction tools, not as places to park long-term savings."
products:
  - name: "Wise"
    url: "https://go.expatnetherlandshub.com/wise?ref=/blog/dutch-deposit-guarantee-scheme-expats-2026/"
    price: "Free account, fees per transfer"
    tag: "Multi-currency transfers"
---

Most expats open a Dutch bank account in their first weeks, transfer a chunk of savings across, and never think about what would happen if the bank failed. It is a reasonable thing not to think about — Dutch banking is heavily supervised and bank failures here are rare. But the question comes up sharply in two specific situations: when you move a lump sum across borders (a house sale, a pension transfer, a relocation package), and when you start spreading savings between the newer app-based providers that pay better interest than the big three.
...
💡 *Related: [getting a Dutch bank account step by step](/blog/getting-a-dutch-bank-account-step-by-step-2026/), [best banking for expats in the Netherlands](/blog/best-banking-expats-netherlands-2026/), [best savings account Netherlands](/guides/finance/best-savings-account-netherlands-2026/).*
...
The practical rule I would apply: use these providers for what they are good at, and do not treat them as a savings home.

<a href="https://go.expatnetherlandshub.com/wise?ref=/blog/dutch-deposit-guarantee-scheme-expats-2026/" target="_blank" rel="nofollow sponsored noopener">Wise</a> is a good example of the distinction in practice. It is genuinely useful for moving money between currencies and holding a working balance in the currencies you actually transact in, and its exchange rates and fee transparency are why it appears throughout this site. It is not the place to hold your emergency fund, precisely because the balance is safeguarded rather than deposit-guaranteed. Move money through it; hold savings at a licensed bank. For the mechanics and the fee structure, see the [Wise review for expats in the Netherlands](/guides/finance/wise-review-expats-netherlands-2026/) and [how to send money home from the Netherlands](/blog/how-to-send-money-home-from-netherlands-2026/).
...
No. Electronic money institutions are not banks and have no deposit guarantee. They must safeguard customer funds separately from company money, which is meaningful but legally different. Use them for transfers and working balances, and keep savings at a licensed bank.
...
The last of those is the one I would flag hardest for internationals. A typical expat wallet contains a Dutch bank, an EU neobank and a currency provider, and they sit under three different protection regimes. Sorting out which is which takes an afternoon and one look at each provider's depositor information sheet.

Use <a href="https://go.expatnetherlandshub.com/wise?ref=/blog/dutch-deposit-guarantee-scheme-expats-2026/" target="_blank" rel="nofollow sponsored noopener">Wise</a> for what it is genuinely best at — moving money between currencies without the spread a bank adds — and keep your guaranteed savings where a guarantee actually exists.

For the next steps see [best banking for expats in the Netherlands](/blog/best-banking-expats-netherlands-2026/), [best savings account Netherlands](/guides/finance/best-savings-account-netherlands-2026/), and [Dutch box 3 tax on savings](/guides/finance/dutch-box-3-tax-savings-expats-2026/).

---

*Sarah van den Berg is an expat coach and writer at ExpatNetherlandsHub.com. This article is general information, not financial advice. Coverage details and eligibility are set out in each bank's depositor information sheet and by De Nederlandsche Bank — check those for your own situation.*
